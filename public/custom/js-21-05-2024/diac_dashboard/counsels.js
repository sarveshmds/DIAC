		...
		$.ajax({
			...
			success: function (response) {
				...
				if (response.status == true) {
					...
					$("#permanent_address_1").val(response.data.perm_address_1);
					$("#permanent_address_2").val(response.data.perm_address_2);
					$(
					...
					$("#permanent_pincode").val(response.data.perm_pincode);
					$("#corr_address_1").val(response.data.corr_address_1);
					$("#corr_address_2").val(response.data.corr_address_2);
					$(
						'#corr_country option[value="' + response.data.corr_country + '"]'
					).prop("selected", true);
					get_states(
...
function fieldsEnable() {
	...
	$("#permanent_address_1").attr("readonly", false);
	$("#permanent_address_2").attr("readonly", false);
	$("#permanent_country").attr("disabled", false);
	$("#permanent_state").attr("disabled", false);
	$("#permanent_pincode").attr("readonly", false);
	$("#corr_address_1").attr("readonly", false);
	$("#corr_address_2").attr("readonly", false);
	$("#corr_country").attr("disabled", false);
	$("#corr_state").attr("disabled", false);
	$("#corr_pincode").attr("readonly", false);
}
function fieldsDisable() {
	...
	$("#permanent_address_1").attr("readonly", true);
	$("#permanent_address_2").attr("readonly", true);
	$("#permanent_country").prop("disabled", true);
	$("#permanent_state").attr("disabled", true);
	$("#permanent_pincode").attr("readonly", true);
	$("#corr_address_1").attr("readonly", true);
	$("#corr_address_2").attr("readonly", true);
	$("#corr_country").attr("disabled", true);
	$("#corr_state").attr("disabled", true);
	$("#corr_pincode").attr("readonly", true);
}
$(document).ready(function () {
	fieldsDisable();
});
