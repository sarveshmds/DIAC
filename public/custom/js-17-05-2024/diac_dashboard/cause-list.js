	...
	columns: [
		...
		{ data: "remarks" },
		{
			...
			render: function (data, type, row, meta) {
				...
				return (
					'<button class="btn btn-primary btn-sm" onclick="btnCancelCauseList(event)" data-tooltip="tooltip" title="Cancel Hearing"><span class="fa fa-times"></span></button> <button class="btn btn-danger btn-sm" onclick="btnDeleteCauseList(' +
					data +
					')" data-tooltip="tooltip" title="Delete cause list"><span class="fa fa-trash"></span></button>'
				);
			},
		},
	],
...
$(document).ready(function () {
	...
	$(".timepicker").timepicker({
		...
		showMeridian: false, // Display time in 24-hour format
					...
					if (hearings.length > 0) {
						...
						hearings.forEach((hearing) => {
							...
							<div class="box box-body form-group p-10">
								<h5 class="mb-0">
									<strong><span class="text-warning">Conference Room ${
										hearing.room_no
