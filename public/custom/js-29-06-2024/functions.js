			...
			content = `
                                            <table class="table" style="border: 1px solid lightgrey; margin-bottom: 10px;">
                                                <tr class="assessment-tr-heading">
                                                    ...
                                                    <td>Rs.${claim_amount}</td>
                                                </tr>
                                                <tr>
                                                    <th>Arbitrator’s Fees:</th>
                                                    <td>Rs.${data.total_arbitrator_fees}</td>
                                                </tr>
                                                <tr>
                                                    <th>Basic Arbitrator’s Fees:</th>
                                                    <td>Rs.${data.basic_arbitrator_fees}</td>
                                                </tr>
                                                <tr>
                                                    <th>${data.excess_amount_percent_details.text}:</th>
                                                    <td>Rs.${data.excess_amount_percent_details.excess_amount_percent}</td>
                                                </tr>
                                                <tr>
                                                    <th>${data.additional_arb_fees_details.text}:</th>
                                                    <td>Rs.${data.additional_arb_fees_details.aaf_total_fee_percent}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Rs.${data.each_party_share_in_arb_fees}</td>
                                                </tr>
                                                <tr>
                                                    <th>Miscellaneous Expenses:</th>
                                                    <td>Rs.${data.administrative_charges}</td>
                                                </tr>
                                                <tr>
                                                    <th>Each Party Payable:</th>
                                                    <td>Rs.${data.each_party_payable}</td>
                                                </tr>
		...
		if (data.administrative_charges_details.claim_amount_rupee > 1000000) {
			content += `<tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>Rs.${Math.ceil(
																							data
																								.administrative_charges_details
																								.claim_amount_rupee
																						)}</td>
                                        </tr>
                                        <tr>
