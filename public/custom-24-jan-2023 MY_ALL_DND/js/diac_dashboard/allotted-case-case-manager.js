	...
	columns: [
		...
		},
		{
			...
			<div class="btn-group dropleft">
				<button type="button" class="btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Responses <i class="fa fa-chevron-down"></i></button>
