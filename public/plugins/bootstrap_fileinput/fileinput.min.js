		...
		(i.prototype = {
					...
					(i = a.resumableManager =
						{
							...
							sendAjax: function (e, s, l) {
								...
								if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
									if (s > r.maxRetries)
										return (
											v(m.resumableMaxRetriesReached, { n: r.maxRetries }),
									...
									(h = new FormData()),
										...
										(C = function (t, r, n) {
											return a._isAborted()
												? void v(m.resumableAborting)
												: ((w = a._getOutData(h, t)),
												  i.setAjaxError(t, r, n),
												  a._raise("filechunkajaxerror", [u, e, s, o, i, w]),
												  i.pushAjax(e, s + 1),
												  void v(m.resumableRetryError, { n: s - 1 }));
										}),
										(x = function () {
											a._isAborted() ||
			...
			_initTemplateDefaults: function () {
				...
				(i =
					...
					(B = " {style}"),
					(S = V("html", "text/html")),
					(I = V("text", "text/plain;charset=UTF-8")),
					(M = V("pdf", "application/pdf")),
					(E =
					...
					get: function (e, a) {
						...
						return m && m.length
							? ((a = void 0 === a ? !0 : a),
							  ...
							  (r = g
									? h(o, m, l, d, s, u, c)
									: h("generic", m, l, d, s, u, c, o).setTokens({
											content: p.content[e],
									  })),
			...
			_setZoomContent: function (i, a) {
				...
				y &&
					...
					(g = w.html().replace(t.ZOOM_VAR, "").setTokens({ zoomData: y })),
					w.html(g),
					i.data("zoom", ""),
					w.attr("data-zoom", y)),
					...
					(f = i.data("caption") || v.msgZoomModalHeading),
					(m = i.data("size") || ""),
					...
					u &&
						(v.showDescriptionClose &&
							(u =
								v
									._getLayoutTemplate("descriptionClose")
									.setTokens({ closeIcon: v.previewZoomButtonIcons.close }) +
								"</button>" +
								u),
						p.show().html(u),
						v.showDescriptionClose &&
							v._handler(b.find(".kv-desc-hide"), "click", function () {
								e(this)
									.parent()
					...
					b.data("previewId", h),
					v._handler(b.find(".btn-kv-prev"), "click", function () {
				...
				return (
					...
					(w = function (a, l, d, u, g) {
						...
						return (
							...
							d && ((v.zoomCache = ""), (v.zoomData = "{zoomData}")),
							w.setTokens(v)
						);
					}),
					...
					(v = w(S ? "other" : i, a, !1, "kv-preview-thumb", g)),
			...
			_previewFile: function (e, i, a, r, n) {
				if (this.showPreview) {
					var o,
						...
						v = g.getId(i),
						h = s._getThumbId(v);
					(o = s._generatePreviewTemplate(u, m, l, d, h, v, !1, f)),
						s._clearDefaultPreview(),
						s._addToPreview(p, o);
					var w = s._getFrame(h);
					s._validateImageOrientation(w.find("img"), i, h, v, c, d, f, m),
			...
			_getResizedImage: function (i, a, r, n) {
				...
				if (
					...
					(g = [i, F, S]),
					(!f || !y || (C >= w && x >= b)) &&
						(y && f && v._raise("fileimageresized", g),
						r.val++,
						r.val === n && v._raise("fileimagesresized"),
						!y))
				)
					return void c(v.msgImageResizeError, m, "fileimageresizeerror");
				(k = k || v.resizeDefaultImageType),
					(s = w > C),
					(l = b > x),
					(_ =
			...
			_renderFileFooter: function (e, i, a, r, n) {
				var o,
					...
					w = g.setTokens({ indicator: v, indicatorTitle: h });
				return (
					(a = l._getSize(a)),
					(s = {
						type: e,
					...
					(a = function (w) {
						...
						if (j) {
							...
							if (
								...
								var q = { id: U, index: w, fileId: E, file: j, files: i };
								return (
