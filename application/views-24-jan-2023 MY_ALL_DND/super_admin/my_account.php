					...
					?>
						<div class="box-body box-profile">
							<img class="profile-user-img img-responsive img-circle"
								src="<?php echo base_url(); ?><?php echo $dept_details['user_logo']; ?>"
							...
							<button type="button" class="btn btn-custom btn-block" id="btn_change_password"
								data-user_code="<?php echo $dept_details['user_code']; ?>"
								data-user_name="<?php echo $dept_details['user_name']; ?>">Change Password</button>
						</div>
						<!-- /.box-body -->
						<?php	
						endforeach;
						...
						<div class="modal-content">
							...
							<div class='modal-body'>
								<section class="">
									...
									<div class='row'>
										<div id="errorlog_dept"
											style="display: none;color: red; font-size: 10px; text-align: center;font-weight: bold;">
										</div>
										<div class='demo timeline-block'>
											<input type="hidden" id="hid_user_code" name="hid_user_code" />
											<input type="hidden" name="csrf_profile_token"
												value="<?php echo generateToken('frm_profile_modification'); ?>">
											<div class="col-md-12">
												<div class="form-group col-md-6">
													<label>Profile Description :</label>
													<input style="width: 100%;" id="dept_desc" name="dept_desc"
											...
											<div class="col-md-12">
												<div class="form-group col-md-6">
													...
													<input type="text" id="txt_email" name="txt_email" class="form-control"
														placeholder="Eg:xxx@gmail.com" autocomplete="off">
												</div>
												<div class="form-group col-md-6">
													<label>Address :</label>
													<input type="text" id="txt_dept_address" name="txt_dept_address"
											...
											<div class="col-md-12">
												<div class="form-group col-md-12">
													...
													<input type="file" class="form-control filestyle" name="txt_Logo"
														id="txt_Logo" value="" autocomplete="off">
												</div>
											</div>
											<div class="col-md-12" align="center">
												<input type="submit" class="btn btn-custom"
													style="width: 30%;margin-top: 10px" value="Submit">
											</div>
										</div>
									</div>
									<?php echo form_close();?>
				...
				<div class="modal fade" id="change_password_modal" role="dialog">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class='modal-body'>
								<div id="errorlog_cp"
									style="display: none;color: red; font-size: 14px; text-align: center;font-weight: bold;">
								</div>
								<div class=''>
									...
									<input type="hidden" name="csrf_cp_token"
										value="<?php echo generateToken('frm_change_password'); ?>">
									<div class="form-group">
										<label for="old_password">Old Password</label>
										<input type="password" id="txt_old_password" name="txt_old_password"
											class="form-control" placeholder="enter your old password" autocomplete="off">
									</div>
									<div class="form-group">
										<label for="new_password">New Password</label>
										<input type="password" id="txt_new_password" name="txt_new_password"
											class="form-control" placeholder="enter your new password" autocomplete="off">
									</div>
									<div class="form-group">
										<label for="confrim_password">Confirm Password</label>
										<input type="password" id="txt_confrim_password" name="txt_confrim_password"
											class="form-control" placeholder="confirm password" autocomplete="off">
									</div>
									<div class="form-group" align="center">
										<input type="submit" class="btn btn-custom" style="width: 30%;margin-top: 10px"
											value="Submit">
									</div>
								</div>
							</div>
...
<script type="text/javascript" language="javascript"
	src="<?php echo base_url(); ?>public/custom/js/super_admin/my_account.js"></script>
