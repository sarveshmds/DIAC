...
<script>
    $(document).ready(function() {
        var datatable_document_pleadings = $("#datatable_document_pleadings").dataTable({
            ...
            searching: false,
            ajax: {
                url: base_url + "ims/efiling/document-pleadings/get-datatable-list",
                type: "POST",
                data: function(data) {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    sClass: "text-center",
                    render: function(data, type, row, meta) {
                        return "<a href='" + base_url + "ims/other-notings?noting_group=" + customURIEncode('EFILING') + "&type_code=" + customURIEncode(data.d_code) + "&type_name=" + customURIEncode('DOCUMENT_PLEADINGS') + "' class='btn bg-maroon btn-sm'> Click <i class='fa fa-arrow-right'></i></a>";
                    },
                },
                {
                    data: null,
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        return " <a href='" + base_url + "public/upload/efiling/documents/" + data.upload + "' class='action-icon tooltipTable tooltipTable btn btn-primary btn-sm' title='View Document' target='_BLANK'><i class='fa fa-file'></i></a> " + button;
                    },
                },
            ],
            columnDefs: [{
    ...
    $("#change_status_form").bootstrapValidator({
        ...
        submitHandler: function(validator, form, submitButton) {
            ...
            $.ajax({
                url: base_url + "change_document_status",
                method: "POST",
                data: formData,
                contentType: false,
                processData: false,
