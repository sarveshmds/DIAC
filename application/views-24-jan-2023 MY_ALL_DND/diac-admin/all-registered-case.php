						...
						<div>
							<div class="row flex-row" style="    align-items: flex-end;">
								...
								<div class="col-md-4">
									...
									<div class="text-right" style="margin-bottom: 5px;">
										...
										<a href="<?= base_url('excel/registered-cases-list') ?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Excel</a>
										<a href="<?= base_url('pdf/registered-cases-list') ?>" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> PDF</a>
									</div>
								</div>
							</div>
							...
							<div class="nav-tabs-custom">
								<ul class="nav nav-tabs">
									<li class="active"><a href="#tab_1" class="rc_nav_link" data-toggle="tab" aria-expanded="true" data-case-type="GENERAL">General Cases</a></li>
									<li class=""><a href="#tab_2" class="rc_nav_link" data-toggle="tab" aria-expanded="false" data-case-type="EMERGENCY">Emergency Cases</a></li>
