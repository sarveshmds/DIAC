					...
					<div class="box-body">
						<div>
							...
							<ul class="nav nav-tabs" id="nav-tab" role="tablist">
								<li class="active">
									<a class="nav-item nav-link" id="nav-sop-tab" data-toggle="tab" href="#nav-sop" role="tab" aria-controls="nav-sop" aria-selected="true">Fee</a>
								</li>
									...
									<div class="tab-content-col">
										...
										<?php if ($this->session->userdata('role') != 'ACCOUNTS') : ?>
											<div class="text-right">
												...
												<a href="<?= base_url('case-fees-details/add-assessment/' . $case_no) ?>" class="btn btn-custom"><i class="fa fa-plus"></i> Add Assessment</a>
											</div>
										<?php endif; ?>
