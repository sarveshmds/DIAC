                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                        <div class="card card-plain mt-8">
                            <div class="card-header pb-0 text-left bg-transparent" style="border: none !important;">
                                <h3 class="font-weight-bolder text-info text-gradient">OTP Verification</h3>
                                <small class="mb-2 d-block">
                                    Enter your OTP to verify your account.
                                </small>
                            </div>
                            <div class="card-body" style="padding-top: 5px !important;">
                                <form role="form" id="fp_otp_form" name="fp_otp_form">
                                    <input type="hidden" name="csrf_fp_otp_form_token" id="csrf_fp_otp_form_token" value="<?php echo generateToken('fp_otp_form'); ?>">
                                    <label>OTP</label>
                                    <div class="mb-3">
                                        <input type="text" class="form-control" name="otp" id="otp" placeholder="OTP" aria-label="otp" aria-describedby="email-addon">
                                    </div>
...
<script>
    $('#fp_otp_form').validate({
        ...
        submitHandler: function(form, event) {
            ...
            $.ajax({
                url: base_url + 'efiling/forgot-password/otp-verify',
                data: $('#fp_otp_form').serialize(),
                type: 'POST',
