                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        if (data.application_status == 2) {
                            button = "<a href='" + base_url + "efiling/document/edit?id=" + data.id + "' class='action-icon tooltipTable tooltipTable btn btn btn-info btn-sm'  id='edit' title='Edit'><i class='fa fa-edit'></i></a>";
                        }
                        return button + " <a href='" + base_url + "public/upload/efiling/documents/" + data.upload + "' class='action-icon tooltipTable tooltipTable btn btn-warning btn-sm' title='View Document' target='_BLANK'><i class='fa fa-file'></i> File</a>";
                    },
                },
            ],
            columnDefs: [{
