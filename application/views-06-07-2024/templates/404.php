	...
	<body>
		<div id="notfound">
			<div class="notfound">
				...
				<?php if($this->session->userdata('user_code')): ?>
					<a href="Javascript:void(0)" onclick="history.back()" class="custom-btn">Go back</a>
				<?php else: ?>
					<a href="<?= base_url() ?>" class="custom-btn">Go to home</a>
				<?php endif; ?>
			</div>
		</div>
	</body>
