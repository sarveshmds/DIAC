							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group col-md-3">
										...
										<select class="form-control select2" id="filter_case_status" name="filter_case_status">
											<option value="">Select</option>
											<?php foreach ($get_case_status as $gcs) : ?>
												<option value="<?= $gcs['gen_code'] ?>"><?= $gcs['description'] ?></option>
											<?php endforeach; ?>
										</select>
									</div>
									<div class="form-group col-md-3">
										<label class="control-label">Minor Case Status:</label>
										<select class="form-control select2" id="filter_minor_case_status" name="filter_minor_case_status">
											<option value="">Select</option>
											<?php foreach ($get_minor_case_status as $gmcs) : ?>
												<option value="<?= $gmcs['code'] ?>"><?= $gmcs['name'] ?></option>
											<?php endforeach; ?>
										</select>
									</div>
									<div class="form-group col-md-3">
										<label class="control-label">Arbitrator Status:</label>
										<select class="form-control select2" id="filter_arbitrator_status" name="filter_arbitrator_status">
											<option value="">Select</option>
											<?php foreach ($arbitrator_status as $as) : ?>
												<option value="<?= $as['gen_code'] ?>"><?= $as['description'] ?></option>
											<?php endforeach; ?>
										</select>
									</div>
