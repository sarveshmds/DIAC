                        ...
                        <div>
                            <fieldset class="fieldset" id="filters-fieldset">
                                ...
                                <div class="col-xs-12 flex-row">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 form-group">
                                        <label class="control-label">Is Gar Live</label>
                                        <select name="registration_for_gar_live" id="registration_for_gar_live" class="form-control">
                                            <option value="">Select</option>
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 form-group">
                                        ...
                                        <select name="training_session" id="training_session" class="form-control">
                                            <option value="">Select</option>
                                            <option value="session_i">Session I</option>
                                            <option value="session_ii">Session II</option>
                                        </select>
                                    </div>
                            ...
                            <table id="datatable_daw_registrations" class="table table-condensed table-striped table-bordered nowrap" data-page-size="10">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Registered for Gar Live</th>
                                        <th>Registered for Training Session</th>
                                        <th>Organization</th>
                                        <th>Country</th>
                                        <th>State</th>
...
<script>
    function generate_registrations_excel() {
        ...
        var registration_for_gar_live = $("#registration_for_gar_live").val();
        var training_session = $("#training_session").val();
        ...
        form.method = 'POST';
        form.target = '_BLANK';
        form.action = base_url + 'daw-2024/registration/generate-excel';
        ...
        element1.value = JSON.stringify({
            filter_data: {
                ...
                registration_for_gar_live: registration_for_gar_live
            }
        });
    ...
    function generate_registrations_pdf() {
        ...
        var f_country = $("#f_country").val();
        var dt_application_status = $("#dt_application_status").val();
        var gar_live = $("#registration_for_gar_live").val();
        var training_session = $("#training_session").val();
        ...
        form.method = 'POST';
        form.target = '_BLANK';
        form.action = base_url + 'daw-2024/registration/generate-pdf';
        element1.name = 'filter_data';
        ...
        document.body.appendChild(form);
        form.submit();
        // window.open(base_url + 'daw-2024/registration/generate-pdf', '_BLANK');
    }
    ...
    var dataTable = $("#datatable_daw_registrations").DataTable({
        ...
        order: [],
        ajax: {
            url: base_url + 'daw-2024/get-all-registrations',
            type: "POST",
            data: function(d) {
                ...
                d.registration_for_gar_live = $("#registration_for_gar_live").val();
                d.dt_application_status = $('#dt_application_status').val();
                d.training_session = $('#training_session').val();
            },
        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    return (
                        '<a href="' + base_url + 'daw-2024/registration/view?id=' + data.id + '" type="button" class="btn btn-success btn-sm" data-tooltip="tooltip" title="View Details"><span class="fa fa-eye"></span></a> '
                    );
                },
            },
            {
                ...
                render: function(data, type, row, meta) {
                    ...
                    if (data.application_status == 4) {
                        app_status_desc = '<span class="badge bg-olive">Payment Received</span>';
                    }
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    var gar_live_status;
                    if (data.registration_for_gar_live == 1) {
                        gar_live_status = '<span class="badge bg-green">Yes</span>';
                    }
                    if (data.registration_for_gar_live == 0) {
                        gar_live_status = '<span class="badge bg-red">No</span>';
                    }
                    return gar_live_status;
                },
            },
            {
                data: null,
                sClass: "alignCenter",
                render: function(data, type, row, meta) {
                    var trainingSession = '<span class="badge bg-danger">Not Registered</span>';

                    if (data.registration_for_training_session) {
                        if (data.registration_for_training_session == 'session_i') {
                            trainingSession = '<span class="badge bg-green">Session I</span>';
                        }
                        if (data.registration_for_training_session == 'session_ii') {
                            trainingSession = '<span class="badge bg-red">Session II</span>';
                        }
                    }
            ...
            // {
            //     data:"registration_for_training_session"
            // },
            {
                data: "organization"
            },
    ...
    $('#btn_reset').on('click', function() {
        ...
        $("#registration_for_gar_live option").prop('selected', false);
        $("#training_session option").prop('selected', false);
        dataTable.ajax.reload();
    })
</script>