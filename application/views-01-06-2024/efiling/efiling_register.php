    ...
    <div class="container">
        <div class="card mt-4 mb-4 bg-white rounded shadow">
            <div class="card-header pt-4 flex-column align-items-start">
                <h5 class="card-title text-danger">E-filing Registration</h5>
                <p class="text-lead text-dark mb-0">Register here for e-filing and viewing your case details.</p>
            </div>
                ...
                <form id="reg_frm" class="reg_frm" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 col-12" id="ef_empanellment_no_col" style="display: none;">
                            <div class="mb-3">
                                <label for="" class="form-label">Empanelment No.</label>
                                ...
                                <div class="fieldset-content-col">
                                    <div class="mb-1">
                                        <div class="form-check">
                                            ...
                                            <label class="form-label" for="arbitrator_fees_checked">Same as correspondance address</label>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label">Address</label>
                    ...
                    <div class="row">
                        <div class="col-12 mt-4">
                            <div class="mb-2 d-flex align-items-center justify-content-center">
                                ...
                                <button class="login-reload-captcha-btn btn border-0" type="button" value="" name="btnReload" id="btnReload"><i class="fa fa-refresh"></i></button>
                            </div>
                    ...
                    <div class="text-center mb-4">
                        <button type="submit" class="btn btn-warning"><i class="fa fa-user-plus"></i> Register</button>
                    </div>
                    <p class="text-sm mt-3 mb-0">Already have an account? <a type="" href="<?= base_url('efiling/register') ?>" class="text-warning font-weight-bolder"> Login</a></p>
                </form>
            </div>
        </div>
    </div>
