			...
			<div class="modal-body">
				...
				<div id="car_wrapper">
					<div class="row">
						...
						<div class="form-group col-lg-2 col-md-3 col-sm-6 col-xs-12 counter_claimant_col" style="display: none;">
						...
						<div class="form-group col-lg-2 col-md-3 col-sm-6 col-xs-12">
							...
							<input type="text" class="form-control uppercase" id="car_additional_email" name="car_additional_email" autocomplete="off" maxlength="200" value="">
							<small class="text-muted">(,) Comma seperated values</small>
						</div>
								...
								<div class="fieldset-content-box">
									<div class="row">
										...
										<div class="form-group col-lg-2 col-md-3 col-sm-6 col-xs-12">
											...
											<input type="text" class="form-control" id="perm_pincode" name="perm_pincode" autocomplete="off" maxlength="200" value="" />
										</div>
									</div>
								</div>
							</fieldset>
							...
							<fieldset class="fieldset">
								...
								<div class="fieldset-content-box">
									<div class="row">
										...
										<div class="form-group col-lg-2 col-md-3 col-sm-6 col-xs-12">
											<label class="control-label">Address Line 1:</label>
											<textarea class="form-control uppercase" id="corr_address1" name="corr_address1" autocomplete="off"></textarea>
										</div>
										<div class="form-group col-lg-2 col-md-3 col-sm-6 col-xs-12">
											<label class="control-label">Address Line 2:</label>
											<textarea class="form-control uppercase" id="corr_address2" name="corr_address2" autocomplete="off"></textarea>
										</div>

										<div class="form-group col-lg-2 col-md-3 col-sm-6 col-xs-12">
											<label class="control-label">City:</label>
											<input type="text" class="form-control uppercase" id="corr_city" name="corr_city" autocomplete="off" maxlength="100" value="" />
										</div>
										...
										<div class="form-group col-lg-2 col-md-3 col-sm-6 col-xs-12">
											<label class="control-label">Pincode:</label>
											<input type="text" class="form-control" id="corr_pincode" name="corr_pincode" autocomplete="off" maxlength="200" value="" />
										</div>
									</div>
								</div>
							</fieldset>
