...
class Arbitral_tribunal_model extends CI_Model
{
    ...
    public function getBasicArbitratorData($case_code)
    {
        ...
        $this->db->select('catt.at_code, catt.whether_on_panel, catt.case_no, catt.arb_terminated, mat.name_of_arbitrator as mat_name_of_arbitrator, mat.contact_no, mat.email, mat.name_of_arbitrator');
