	...
	*/
    ...
    public function _remap($method)
    {
        ...
        $role_action_auth = array(
            ...
            'DEPUTY_COUNSEL' => array('all_tag_cases', 'all_tagged_case_datatable', 'store_tagged_case', 'get_single_tagged_case_details', 'update_tagged_case', 'delete_tagged_case'),
            'CASE_MANAGER' => array('all_tag_cases', 'all_tagged_case_datatable', 'store_tagged_case', 'get_single_tagged_case_details', 'update_tagged_case', 'delete_tagged_case'),
            'COORDINATOR' => array('all_tag_cases', 'all_tagged_case_datatable', 'store_tagged_case', 'get_single_tagged_case_details', 'update_tagged_case', 'delete_tagged_case'),
            'ACCOUNTS' => array('all_tag_cases', 'all_tagged_case_datatable', 'store_tagged_case', 'get_single_tagged_case_details', 'update_tagged_case', 'delete_tagged_case'),
        );
