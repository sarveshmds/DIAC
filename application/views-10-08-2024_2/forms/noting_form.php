...
<input type="hidden" id="noting_op_type" name="op_type" value="ADD_CASE_NOTING">
...
<div id="fr_wrapper">
    <div class="row">
        ...
        <div class="form-group col-md-12 col-sm-12 col-xs-12">
            <label class="control-label">Next Date: <span class="text-danger">*</span></label>
        ...
        <div class="form-group col-md-12 col-sm-6 col-xs-12">
            ...
            <input type="file" class="form-control noting_file_input" name="cd_noting_file[]" id="cd_noting_file" accept=".pdf, .doc, .docx" multiple>
