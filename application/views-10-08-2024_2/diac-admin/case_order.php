...
<script type="text/javascript" src="<?= base_url('public/custom/js/diac_dashboard/case_order.js?v=' . filemtime(FCPATH . 'public/custom/js/diac_dashboard/case_order.js')) ?>"></script>