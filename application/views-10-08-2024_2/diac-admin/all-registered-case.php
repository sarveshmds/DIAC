							...
							<div class="row flex-row" style="align-items: flex-end;">
								...
								<div class="col-md-4">
									...
									<div class="text-right" style="margin-bottom: 5px;">
										...
										<button type="button" id="btn_rc_excel_download" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Excel</button>
										<!-- <a href="#" class="btn btn-danger" target="_BLANK"><i class="fa fa-file-pdf-o"></i> PDF</a> -->
									</div>
								</div>
							</div>
...
<script type="text/javascript" src="<?= base_url('public/custom/js/diac_dashboard/all-registered-cases.js?v=' . filemtime(FCPATH . 'public/custom/js/diac_dashboard/all-registered-cases.js')) ?>"></script>