<div class="box box-danger mt-10 collapsed-box">
    ...
    <div class="box-body fees-assessment-fixed-body">
        ...
        <?php if (in_array($this->session->userdata('role'), ['DEPUTY_COUNSEL', 'CASE_MANAGER', 'COORDINATOR'])) : ?>
                                    ...
                                    <div>
                                        ...
                                        <table class="table table-responsive table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <!-- If counter claim is not assessed seperately and they are rentered with claims then we have to show claim and counter claim as one -->
                                                <?php if ((isset($fc['c_cc_asses_sep']) && $fc['c_cc_asses_sep'] == 'no') && isset($fee_prayers['cc_claim_prayers']) && count($fee_prayers['cc_claim_prayers']) > 0) : ?>
                                                    <?php foreach ($fee_prayers['cc_claim_prayers'] as $ccp) : ?>

                                                        <?php if ($ccp['assessment_code'] == $fc['code']) : ?>
                                                            <tr>
                                                                <td><?= $ccp['type'] ?></td>
                                                                <td><?= $ccp['prayer_name'] ?></td>
                                                                <td><?= ($ccp['applicable']) == 1 ? 'Yes' : 'No' ?></td>
                                                                <td><?= ($ccp['is_quantified']) == 1 ? 'Yes' : 'No' ?></td>
                                                                <td><?= (isset($ccp['prayer_amount']) && !empty($ccp['prayer_amount'])) ? symbol_checker($case_data['type_of_arbitration'], $ccp['prayer_amount']) : '' ?></td>
                                                            </tr>
                                                            <!-- Total amount of counter claim will be added in claims amount -->
