                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <!-- <a href="<?= base_url('efiling/empanellment/new-form') ?>" class="btn btn-warning w-100"><i class="fa fa-paper-plane" id="emp_submit"></i> Get OTP</a> -->
                                            <button class="btn btn-warning w-100"><i class="fa fa-paper-plane" id="emp_submit"></i> Proceed</button>
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="steps steps-vertical">
                                    ...
                                    <li class="step-item">
                                        <div class="h3 m-0">Step-3 - Document Uploads</div>
