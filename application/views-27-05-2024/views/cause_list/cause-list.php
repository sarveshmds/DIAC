					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab_1">
							<div class="table-responsive">
								<table id="dataTableTodaysCauseList" class="table table-condensed table-striped table-bordered" data-page-size="10">
						...
						<div class="tab-pane" id="tab_2">
							...
							<div class="table-responsive">
								<table id="dataTableYoursCauseList" class="table table-condensed table-striped table-bordered" data-page-size="10">
									<input type="hidden" id="csrf_trans_token" value="<?php echo generateToken('dataTableCauseList'); ?>">
									<thead>
										<tr>
											<th style="width:7%;">S. No.</th>
