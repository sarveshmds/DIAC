    ...
    <section class="wrapper_section">
        <div class="container download_container">
            <p class="mb-0">
                ...
                <span class="badge bg-green"><?= $person['attendance_count'] ?></span>
            </p>

            <a href="<?= base_url('daw-2024/registration/generate-public-single-pdf/' . $encrypted_id) ?>" class="btn btn-danger btn_download" target="_BLANK">
            ...
            <div class="box-body">
                ...
                <div>
                    <table style="width: 100%; margin-bottom: 10px;">
                        <tr>
                            <td width="80px">
                                <img src="<?= base_url() . DAW_PHOTO_UPLOADS_FOLDER . $person['profile_photo'] ?>" alt="" style="width: 80px; border-radius: 2px;">
                            </td>
