...
class Service extends CI_Controller
{
	public function __construct()
	{
		...
		#models
		$this->load->model(array('superadmin_model', 'admin_model', 'getter_model', 'common_model', 'case_model', 'causelist_model', 'fees_model', 'category_model', 'poa_model', 'system_model', 'refferal_request_model', 'ims_efiling_model', 'response_model', 'master_setup/country_model', 'master_setup/state_model', 'master_setup/arbitrator_setup_model', 'claimant_respondent_model', 'arbitral_tribunal_model'));
	}
