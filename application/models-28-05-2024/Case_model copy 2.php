	...
	public function get($data, $op)
	{
		switch ($op) {
			...
			case 'CASE_ALLOTMENT_LIST_GROUPWISE':
				...
				$this->db->select("ca.id, ca.case_no, CONCAT(cdt.case_no_prefix, cdt.case_no) as case_no_desc, cdt.case_title, ca.alloted_to, ca.alloted_by, um.user_display_name as alloted_to_name, DATE_FORMAT(ca.created_at, '%d-%m-%Y') as alloted_on,
				...
				if ($this->form_validation->run()) {
					...
					try {
						...
						$claimant_details_data = array(
							...
							'perm_address1' => $this->security->xss_clean($this->input->post('perm_address1')),
							'perm_address2' => $this->security->xss_clean($this->input->post('perm_address2')),
							...
							'corr_address1' => $this->security->xss_clean($this->input->post('corr_address1')),
							'corr_address2' => $this->security->xss_clean($this->input->post('corr_address2')),
