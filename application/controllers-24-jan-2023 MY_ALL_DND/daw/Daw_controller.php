	...
	*/
	...
	public function _remap($method)
	{
		...
		$role_action_auth = array(
			'DIAC' => array('all_registrations', 'view_registration_details', 'get_all_registrations', 'generate_registrations_excel', 'generate_registrations_pdf', 'generate_registrations_single_pdf', 'payment_pending_registrations'),
			'DAW' => array('all_registrations', 'view_registration_details', 'get_all_registrations', 'generate_registrations_excel', 'generate_registrations_pdf', 'generate_registrations_single_pdf', 'daw_dashboard', 'approved_registrations', 'rejected_registrations', 'pending_registrations', 'payment_pending_registrations'),
		);
