...
class Service extends CI_Controller
{
	public function __construct()
	{
		...
		#models
		$this->load->model(array('superadmin_model', 'admin_model', 'getter_model', 'common_model', 'case_model', 'causelist_model', 'fees_model', 'category_model', 'poa_model', 'system_model', 'miscellaneous_model', 'ims_efiling_model', 'response_model'));
	}
	...
	{
		$data = $this->getter_model->get($_POST, 'GET_ALL_COUNTRIES');
	...
	public function get_all_miscellaneous_list()
	{
		...
		if ($inputCsrfToken != '') {
			if (checkToken($inputCsrfToken, 'dataTableMiscellaneous')) {
				echo json_encode($this->miscellaneous_model->get('', $type));
			} else {
				$data = array(
					'status' => false,
					'msg' => 'Invalid Security Token'
	...
	public function add_miscellaneous_operation()
	{

		$inputCsrfToken = $_POST['csrf_miscellaneous_form_token'];
		if ($inputCsrfToken != '') {
			if (checkToken($inputCsrfToken, 'miscellaneous_form')) {
				echo json_encode($this->miscellaneous_model->post($_POST, $_POST['op_type']));
			} else {
				$data = array(
					'status' => false,
					'msg' => 'Invalid Security Token'
	...
	public function delete_miscellaneous()
	{
		...
		if ($inputCsrfToken != '') {
			if (checkToken($inputCsrfToken, 'dataTableMiscellaneous')) {
				echo json_encode($this->miscellaneous_model->post($_POST, $type));
			} else {
				$data = array(
					'status' => false,
					'msg' => 'Invalid Security Token'
