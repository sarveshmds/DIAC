                    ...
                    <table class="table person_info_tbl">
                        ...
                        <tr>
                            ...
                            <td class="data_col">
                                ...
                                <p><?php
                                    if ($person['registration_for_gar_live'] == 1) {
                                        echo 'Yes';
                                    } elseif ($person['registration_for_gar_live'] == 0) {
                                        echo 'No';
                                    }
                            ...
                            <td class="data_col">
                                ...
                                <p><?php
                                    if ($person['registration_for_training_session'] == 'session_i') {
                                        echo "Session I";
                                    } elseif ($person['registration_for_training_session'] == 'session_ii') {
                                        echo 'Session II';
                                    } else { {
                                            echo 'Not Registered';
                                        }
