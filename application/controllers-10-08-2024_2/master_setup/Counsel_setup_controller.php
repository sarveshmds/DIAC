...
class Counsel_setup_controller extends CI_Controller
{
    ...
    public function _remap($method)
    {
        ...
        $role_action_auth = array(
            ...
            'DEO' => array('index', 'add_counsel', 'get_datatable_data', 'update_counsel', 'delete', 'add_counsel_page', 'add', 'get_datatable_data_unappr', 'edit_counsel', 'update_counsel'),

            'DEPUTY_COUNSEL' => array('index', 'add_counsel', 'get_datatable_data', 'update_counsel', 'delete', 'add_counsel_page', 'add', 'get_datatable_data_unappr', 'edit_counsel', 'update_counsel'),
        );
    ...
    public function add()
    {
        ...
        $this->form_validation->set_rules('enrollment_no', 'Enrollment Number', 'xss_clean');
        $this->form_validation->set_rules('email', 'Email', 'xss_clean|valid_email');
        $this->form_validation->set_rules('phone_number', 'Phone number', 'xss_clean|numeric');
        $this->form_validation->set_rules('perm_add_1', 'Permanent Address 1', 'xss_clean');
        $this->form_validation->set_rules('perm_country', 'Permanent Country', 'xss_clean');
        $this->form_validation->set_rules('perm_state', 'Permanent State', 'xss_clean');
        $this->form_validation->set_rules('perm_pincode', 'Permanent Pincode', 'xss_clean');
        $this->form_validation->set_rules('corr_add_1', 'Correspondence Address 1', 'xss_clean');
        $this->form_validation->set_rules('corr_country', 'Correspondence Country', 'xss_clean');
        $this->form_validation->set_rules('corr_state', 'Correspondence State', 'xss_clean');
        $this->form_validation->set_rules('corr_pincode', 'Correspondence Pincode', 'xss_clean');
        ...
        if ($this->form_validation->run()) {
            ...
            try {
                ...
                $data = array(
                    ...
                    'approved' => ($this->input->post('approved') == 1) ? $this->input->post('approved') : 0,
    ...
    public function get_datatable_data()
    {
        ...
        if ($this->input->post('f_counsel_name')) {
            $this->db->like('mct.name', $this->input->post('f_counsel_name'));
        }
    ...
    public function update_counsel()
    {
        ...
        $this->form_validation->set_rules('name', 'Name of counsel', 'xss_clean');
        $this->form_validation->set_rules('enrollment_no', 'Enrollment Number', 'xss_clean');
        $this->form_validation->set_rules('email', 'Email', 'xss_clean|valid_email');
        $this->form_validation->set_rules('phone_number', 'Phone number', 'xss_clean|numeric');
        $this->form_validation->set_rules('perm_add_1', 'Permanent Address 1', 'xss_clean');
