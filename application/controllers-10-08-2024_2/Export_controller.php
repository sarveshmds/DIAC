...
class Export_controller extends CI_Controller
{
	public function __construct()
	{
		...
		# models
		$this->load->model(array('common_model', 'case_model', 'refferal_request_model', 'fees_model', 'getter_model'));
	}
	...
	*/
	...
	public function _remap($method)
	{
		...
		$role_action_auth = array(
			'ADMIN' => array(
				'print_case', 'generateRegisteredCasePdf', 'generateOtherPleadingsPdf', 'generateOtherCorrespondancePdf', 'generateNotingsPdf', 'generatePanelOfArbitratorsPdf', 'generateCauseListPdf', 'generateAllCasesPdf', 'generateCaseDetailsPdf', 'generateAllCasesExcel'
			),
			'DIAC' => array(
				'print_case', 'generateRegisteredCasePdf', 'generateOtherPleadingsPdf', 'generateOtherCorrespondancePdf', 'generateNotingsPdf', 'generatePanelOfArbitratorsPdf', 'generateCauseListPdf', 'generateAllCasesPdf', 'generateCaseDetailsPdf', 'generateRegisteredCaseExcel', 'generateAllCasesExcel', 'generateMiscellaneousRepliesPdf'
			),
			'CASE_MANAGER' => array(
				'print_case', 'generateRegisteredCasePdf', 'generateOtherPleadingsPdf', 'generateOtherCorrespondancePdf', 'generateNotingsPdf', 'generatePanelOfArbitratorsPdf', 'generateCauseListPdf', 'generateAllCasesPdf', 'generateCaseDetailsPdf', 'generateResponseFormat', 'generateAllCasesExcel', 'inviting_claim_and_seeking_names_of_arbitrator', 'claiming_deficient_fee_from_parties', 'inviting_claim_when_arbitrator_already_appointed', 'seeking_consent_from_arbitrator', 'generateCaseFeesAssessmentPdf', 'generateCaseFeesAssessmentSeparatelyPdf', 'generateCaseFeesAssessmentInternationalPdf', 'generateCaseFeesAssessmentSeparatelyInternationalPdf'
			),
			'CASE_FILER' => array(
				'print_case', 'generateRegisteredCasePdf', 'generateOtherPleadingsPdf', 'generateOtherCorrespondancePdf', 'generateNotingsPdf', 'generatePanelOfArbitratorsPdf', 'generateCauseListPdf', 'generateAllCasesPdf', 'generateCaseDetailsPdf', 'generateRegisteredCaseExcel', 'generateAllCasesExcel', 'generateMiscellaneousRepliesPdf'
			),
			'HEAD_COORDINATOR' => array(
				'print_case', 'generateRegisteredCasePdf', 'generateOtherPleadingsPdf', 'generateOtherCorrespondancePdf', 'generateNotingsPdf', 'generatePanelOfArbitratorsPdf', 'generateCauseListPdf', 'generateAllCasesPdf', 'generateCaseDetailsPdf', 'generateAllCasesExcel', 'generateMiscellaneousRepliesPdf', 'generateCaseFeesAssessmentPdf', 'generateCaseFeesAssessmentSeparatelyPdf', 'generateCaseFeesAssessmentInternationalPdf', 'generateCaseFeesAssessmentSeparatelyInternationalPdf'
			),
			'COORDINATOR' => array(
				'print_case', 'generateRegisteredCasePdf', 'generateOtherPleadingsPdf', 'generateOtherCorrespondancePdf', 'generateNotingsPdf', 'generatePanelOfArbitratorsPdf', 'generateCauseListPdf', 'generateAllCasesPdf', 'generateCaseDetailsPdf', 'generateAllCasesExcel', 'generateMiscellaneousRepliesPdf', 'generateCaseFeesAssessmentPdf', 'generateCaseFeesAssessmentSeparatelyPdf', 'generateCaseFeesAssessmentInternationalPdf', 'generateCaseFeesAssessmentSeparatelyInternationalPdf'
			),
			'ACCOUNTS' => array(
				'print_case', 'generateRegisteredCasePdf', 'generateOtherPleadingsPdf', 'generateOtherCorrespondancePdf', 'generateNotingsPdf', 'generatePanelOfArbitratorsPdf', 'generateCauseListPdf', 'generateAllCasesPdf', 'generateCaseDetailsPdf', 'generateAllCasesExcel', 'generateCaseFeesAssessmentPdf', 'generateCaseFeesAssessmentSeparatelyPdf', 'generateCaseFeesAssessmentInternationalPdf', 'generateCaseFeesAssessmentSeparatelyInternationalPdf'
			),
			...
			'DEPUTY_COUNSEL' => array(
				'print_case', 'generateRegisteredCasePdf', 'generateOtherPleadingsPdf', 'generateOtherCorrespondancePdf', 'generateNotingsPdf', 'generatePanelOfArbitratorsPdf', 'generateCauseListPdf', 'generateAllCasesPdf', 'generateCaseDetailsPdf', 'generateAllCasesExcel',
				'generateCaseFeesAssessmentPdf', 'generateCaseFeesAssessmentSeparatelyPdf', 'generateCaseFeesAssessmentInternationalPdf', 'generateCaseFeesAssessmentSeparatelyInternationalPdf'
			),
		);
	...
	public function generateMiscellaneousRepliesPdf()
	{
		...
		$data['miscellaneous'] = $this->refferal_request_model->get(['id' => $miscellaneous_id], 'GET_MISCELLANEOUS_DATA_USING_ID');
		$data['miscellaneous_replies_list'] = $this->refferal_request_model->get(['miscellaneous_id' => $miscellaneous_id], 'GET_MISCELLANEOUS_REPLIES_LIST_USING_ID');
	...
	public function generateCaseFeesAssessmentPdf()
	{

		if ($this->input->get('id') && $this->uri->segment(3)) {
			$case_slug = $this->uri->segment(3);

			$data['coordinator']  = $this->common_model->get_person_details_of_alloted_case($case_slug, 'COORDINATOR');

			$data['deputy_counsel']  = $this->common_model->get_person_details_of_alloted_case($case_slug, 'DEPUTY_COUNSEL');

			$data['assessment'] =  $this->fees_model->get(['fee_code' => customURIDecode($this->input->get('id'))], 'GET_SINGLE_ASSESSMENT_FEE_DETAILS');

			$data['case_data'] = $this->getter_model->get(['case_slug' => $case_slug], 'GET_CASE_DETAILS');
			...
			$data['page_title'] = 'Fee Assessment';

			$print_data = $this->load->view('system/templates/header', $data, true);
			$print_data .= $this->load->view('system/case-fees-assessment-pdf', $data, true);
			$print_data .= $this->load->view('system/templates/footer', $data, true);

			$this->convert_into_pdf($print_data, $data['page_title'], '');
		} else {
			return redirect('page-not-found');
		}
	}

	public function generateCaseFeesAssessmentSeparatelyPdf()
	{
		...
		if ($this->input->get('id') && $this->uri->segment(3)) {
			...
			$print_data = $this->load->view('system/templates/header', $data, true);
			$print_data .= $this->load->view('system/case-fees-assessment-seperate-pdf', $data, true);
			$print_data .= $this->load->view('system/templates/footer', $data, true);
	...
	public function generateCaseFeesAssessmentInternationalPdf()
	{

		if ($this->input->get('id') && $this->uri->segment(4)) {
			$case_slug = $this->uri->segment(4);
			...
			$print_data = $this->load->view('system/templates/header', $data, true);
			$print_data .= $this->load->view('system/case-fees-assessment-international-pdf', $data, true);
			$print_data .= $this->load->view('system/templates/footer', $data, true);
	...
	public function generateCaseFeesAssessmentSeparatelyInternationalPdf()
	{
		...
		if ($this->input->get('id') && $this->uri->segment(4)) {
			...
			$print_data = $this->load->view('system/templates/header', $data, true);
			$print_data .= $this->load->view('system/case-fees-assessment-seperate-international-pdf', $data, true);
			$print_data .= $this->load->view('system/templates/footer', $data, true);
	...
	public function generateRegisteredCaseExcel()
	{
		$sNo = 1;
		$rowCount = 4;
		$allRegisteredCases = $this->getter_model->get('', 'GET_ALL_REGISTERED_CASES_LIST');
		...
		$this->setCellValue($getActiveSheet, 'I3', 'Ref. Received On');
		$this->setStyle($getActiveSheet, 'I3', array(
			'font'  => array('bold'  => true),
			'alignment' => array('horizontal' => 'center', 'vertical' => 'center', 'wrapText' => true)
		));
		$this->setCellValue($getActiveSheet, 'J3', 'Date of registration');
		$this->setStyle($getActiveSheet, 'J3', array(
			'font'  => array('bold'  => true),
			'alignment' => array('horizontal' => 'center', 'vertical' => 'center', 'wrapText' => true)
		));
		$this->setCellValue($getActiveSheet, 'K3', 'Type of arbitration');
		$this->setStyle($getActiveSheet, 'K3', array(
			'font'  => array('bold'  => true),
			'alignment' => array('horizontal' => 'center', 'vertical' => 'center', 'wrapText' => true)
		));
		$this->setCellValue($getActiveSheet, 'L3', 'Arbitrator Status');
		$this->setStyle($getActiveSheet, 'L3', array(
			'font'  => array('bold'  => true),
			'alignment' => array('horizontal' => 'center', 'vertical' => 'center', 'wrapText' => true)
		));
		$this->setCellValue($getActiveSheet, 'M3', 'Arbitral Tribunal');
		$this->setStyle($getActiveSheet, 'M3', array(
			'font'  => array('bold'  => true),
			'alignment' => array('horizontal' => 'center', 'vertical' => 'center', 'wrapText' => true)
		));
		$this->setCellValue($getActiveSheet, 'N3', 'Case Hearing');
		$this->setStyle($getActiveSheet, 'N3', array(
			'font'  => array('bold'  => true),
			'alignment' => array('horizontal' => 'center', 'vertical' => 'center', 'wrapText' => true)
		));
		$this->setCellValue($getActiveSheet, 'O3', 'Case Status');
		...
		foreach ($allRegisteredCases as $case) {
			...
			$this->setCellValue($getActiveSheet, 'B' . $rowCount, $case['case_no_desc']);
			...
			$this->setCellValue($getActiveSheet, 'I' . $rowCount, formatReadableDate($case['recieved_on']));
			$getActiveSheet->getColumnDimension('I')->setWidth(15);

			$this->setCellValue($getActiveSheet, 'J' . $rowCount, formatReadableDate($case['registered_on']));
			$getActiveSheet->getColumnDimension('J')->setWidth(15);
			$this->setCellValue($getActiveSheet, 'K' . $rowCount, $case['type_of_arbitration_desc']);
			$getActiveSheet->getColumnDimension('K')->setWidth(15);
			$this->setCellValue($getActiveSheet, 'L' . $rowCount, $case['arbitrator_status_desc']);
			$getActiveSheet->getColumnDimension('L')->setWidth(15);
			$this->setCellValue($getActiveSheet, 'M' . $rowCount, $case['amt_name_of_arbitrator']);
			$getActiveSheet->getColumnDimension('M')->setWidth(35);
			$this->setCellValue($getActiveSheet, 'N' . $rowCount, $case['case_status_dec']);
			$getActiveSheet->getColumnDimension('N')->setWidth(15);
			$this->setCellValue($getActiveSheet, 'O' . $rowCount, $case['minor_case_status_name']);
	...
	public function generateAllCasesExcel()
	{
		...
		$this->setCellValue($getActiveSheet, 'M3', 'Case Status');
		$this->setStyle($getActiveSheet, 'M3', array(
			'font'  => array('bold'  => true),
			'alignment' => array('horizontal' => 'center', 'vertical' => 'center', 'wrapText' => true)
		));
		...
		foreach ($allCasesList as $case) {
			...
			$this->setCellValue($getActiveSheet, 'L' . $rowCount, $case['arbitrator_status_desc']);
			$getActiveSheet->getColumnDimension('L')->setWidth(15);
			$this->setCellValue($getActiveSheet, 'M' . $rowCount, $case['case_status_dec']);
