                                                                    ...
                                                                    <table class="property-d-table table" cellpadding="6" style="border:1px solid grey">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><span>&#8377;</span>45,000</td>
                                                                                <!-- <td><?php //echo "<script> formatToIndianNumberingSystem(45000); </script>" ?></td> -->

                                                                            </tr>
                                                                            <tr>
                                                                                <th>Additional Arbitrator's Fees @ 25% of the above: </th>
                                                                                <td><span>&#8377;</span>11,250</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <th>Total Arbitrator's Fees payable: </th>
                                                                                <td><span>&#8377;</span>56,250</td>
                                                                            </tr>
                                                                            <tr>
                                                                                <th>Each Party’s Share of Arbitrator's Fees:</th>
                                                                                <td><span>&#8377;</span>28,125</td>
                                                                            </tr>
                                                                            <tr>
...
<script type="text/javascript">
    ...
    function calc_5_lakhs_to_20_lakhs() {
        ...
        */
        ...
        $('.5lakhsto20lakhs_basic_amount').text(formatToIndianNumberingSystem(basic_amount));
        $('.5lakhsto20lakhs_excess_amount').text(formatToIndianNumberingSystem(excess_amount));
        $('.5lakhsto20lakhs_basic_arbitrator_fees').text(formatToIndianNumberingSystem(basic_arbitrator_fees));
        $('.5lakhsto20lakhs_aarf_excess_amount_percent').text(formatToIndianNumberingSystem(aaf_excess_amount_percent));
        $('.5lakhsto20lakhs_aarf_total_fees_percent').text(formatToIndianNumberingSystem(aaf_total_fee_percent));
        $('.5lakhsto20lakhs_total_arbitrator_fees').text(formatToIndianNumberingSystem(total_arbitrator_fees));
        $('.5lakhsto20lakhs_each_party_share').text(formatToIndianNumberingSystem(each_party_share));
        $('.5lakhsto20lakhs_miscellaneous_expenses').text(formatToIndianNumberingSystem(miscellaneous_expenses));
        $('.5lakhsto20lakhs_each_party_payable').text(formatToIndianNumberingSystem(each_party_payable));

        // new 
        // $('.5lakhsto20lakhs_totalAmount').text(formatToIndianNumberingSystem(totalAmount));
        $('.5lakhsto20lakhs_totalAmount').text(formatToIndianNumberingSystem(totalAmount));
    ...
    function calc_20_lakhs_to_1_crore() {
        ...
        */
        ...
        $('.20lakhsto1crore_basic_amount').text(formatToIndianNumberingSystem(basic_amount));
        $('.20lakhsto1crore_excess_amount').text(formatToIndianNumberingSystem(excess_amount));
        $('.20lakhsto1crore_basic_arbitrator_fees').text(formatToIndianNumberingSystem(basic_arbitrator_fees));
        $('.20lakhsto1crore_aarf_excess_amount_percent').text(formatToIndianNumberingSystem(aaf_excess_amount_percent));
        $('.20lakhsto1crore_aarf_total_fees_percent').text(formatToIndianNumberingSystem(aaf_total_fee_percent));
        $('.20lakhsto1crore_total_arbitrator_fees').text(formatToIndianNumberingSystem(total_arbitrator_fees));
        $('.20lakhsto1crore_each_party_share').text(formatToIndianNumberingSystem(each_party_share));
        $('.20lakhsto1crore_miscellaneous_expenses').text(formatToIndianNumberingSystem(miscellaneous_expenses));
        $('.20lakhsto1crore_each_party_payable').text(formatToIndianNumberingSystem(each_party_payable));

        // new 
        $('.20lakhsto1crore_totalAmount').text(formatToIndianNumberingSystem(totalAmount));
    ...
    function calc_1_crore_to_10_crore() {
        ...
        */
        ...
        $('.1croreto10crore_basic_amount').text(formatToIndianNumberingSystem(basic_amount));
        $('.1croreto10crore_excess_amount').text(formatToIndianNumberingSystem(excess_amount));
        $('.1croreto10crore_basic_arbitrator_fees').text(formatToIndianNumberingSystem(basic_arbitrator_fees));
        $('.1croreto10crore_aarf_excess_amount_percent').text(formatToIndianNumberingSystem(aaf_excess_amount_percent));
        $('.1croreto10crore_aarf_total_fees_percent').text(formatToIndianNumberingSystem(aaf_total_fee_percent));
        $('.1croreto10crore_total_arbitrator_fees').text(formatToIndianNumberingSystem(total_arbitrator_fees));
        $('.1croreto10crore_each_party_share').text(formatToIndianNumberingSystem(each_party_share));
        $('.1croreto10crore_miscellaneous_expenses').text(formatToIndianNumberingSystem(miscellaneous_expenses));
        $('.1croreto10crore_each_party_payable').text(formatToIndianNumberingSystem(each_party_payable));

        // new Col
        $('.1croreto10crore_totalAmount').text(formatToIndianNumberingSystem(totalAmount));
    ...
    function calc_10_crore_to_20_crore() {
        ...
        */
        ...
        $('.10croreto20crore_basic_amount').text(formatToIndianNumberingSystem(basic_amount));
        $('.10croreto20crore_excess_amount').text(formatToIndianNumberingSystem(excess_amount));
        $('.10croreto20crore_basic_arbitrator_fees').text(formatToIndianNumberingSystem(basic_arbitrator_fees));
        $('.10croreto20crore_aarf_excess_amount_percent').text(formatToIndianNumberingSystem(aaf_excess_amount_percent));
        $('.10croreto20crore_aarf_total_fees_percent').text(formatToIndianNumberingSystem(aaf_total_fee_percent));
        $('.10croreto20crore_total_arbitrator_fees').text(formatToIndianNumberingSystem(total_arbitrator_fees));
        $('.10croreto20crore_each_party_share').text(formatToIndianNumberingSystem(each_party_share));
        $('.10croreto20crore_miscellaneous_expenses').text(formatToIndianNumberingSystem(miscellaneous_expenses));
        $('.10croreto20crore_each_party_payable').text(formatToIndianNumberingSystem(each_party_payable));

        // New col
        $('.10croreto20crore_totalAmount').text(formatToIndianNumberingSystem(totalAmount));
    ...
    function calc_above_20_crore() {
        ...
        */
        ...
        $('.above20crore_basic_amount').text(formatToIndianNumberingSystem(basic_amount));
        $('.above20crore_excess_amount').text(formatToIndianNumberingSystem(excess_amount));
        $('.above20crore_basic_arbitrator_fees').text(formatToIndianNumberingSystem(basic_arbitrator_fees));
        $('.above20crore_aarf_excess_amount_percent').text(formatToIndianNumberingSystem(aaf_excess_amount_percent));
        $('.above20crore_aarf_total_fees_percent').text(formatToIndianNumberingSystem(aaf_total_fee_percent));
        $('.above20crore_total_arbitrator_fees').text(formatToIndianNumberingSystem(total_arbitrator_fees));
        $('.above20crore_each_party_share').text(formatToIndianNumberingSystem(each_party_share));
        $('.above20crore_miscellaneous_expenses').text(formatToIndianNumberingSystem(miscellaneous_expenses));
        $('.above20crore_each_party_payable').text(formatToIndianNumberingSystem(each_party_payable));


        $('.above20crore_totalAmount').text(formatToIndianNumberingSystem(totalAmount));
    ...
    function int_calc_10_lakhs_to_50_lakhs() {
        ...
        */
        ...
        $('.int_10lakhsto50lakhs_basic_amount').text(formatToIndianNumberingSystem(basic_amount));
        $('.int_10lakhsto50lakhs_excess_amount').text(formatToIndianNumberingSystem(excess_amount));
        $('.int_10lakhsto50lakhs_basic_arbitrator_fees').text(formatToIndianNumberingSystem(basic_administrative_cost));
        $('.int_10lakhsto50lakhs_aarf_excess_amount_percent').text(formatToIndianNumberingSystem(aaf_excess_amount_percent));
        $('.int_10lakhsto50lakhs_total_arbitrator_fees').text(formatToIndianNumberingSystem(total_arbitrator_fees));
        $('.int_10lakhsto50lakhs_each_party_share').text(formatToIndianNumberingSystem(each_party_share));
        $('.int_10lakhsto50lakhs_each_party_payable').text(formatToIndianNumberingSystem(each_party_payable));
    ...
    function int_calc_50_lakhs_to_1_crore() {
        ...
        */
        ...
        $('.int_50lakhsto1crore_basic_amount').text(formatToIndianNumberingSystem(basic_amount));
        $('.int_50lakhsto1crore_excess_amount').text(formatToIndianNumberingSystem(excess_amount));
        $('.int_50lakhsto1crore_basic_arbitrator_fees').text(formatToIndianNumberingSystem(basic_administrative_cost));
        $('.int_50lakhsto1crore_aarf_excess_amount_percent').text(formatToIndianNumberingSystem(aaf_excess_amount_percent));
        $('.int_50lakhsto1crore_total_arbitrator_fees').text(formatToIndianNumberingSystem(total_arbitrator_fees));
        $('.int_50lakhsto1crore_each_party_share').text(formatToIndianNumberingSystem(each_party_share));
        $('.int_50lakhsto1crore_each_party_payable').text(formatToIndianNumberingSystem(each_party_payable));
    ...
    function int_calc_1_crore_to_10_crore() {
        ...
        */
        ...
        $('.int_1croreto10crore_basic_amount').text(formatToIndianNumberingSystem(basic_amount));
        $('.int_1croreto10crore_excess_amount').text(formatToIndianNumberingSystem(excess_amount));
        $('.int_1croreto10crore_basic_arbitrator_fees').text(formatToIndianNumberingSystem(basic_administrative_cost));
        $('.int_1croreto10crore_aarf_excess_amount_percent').text(formatToIndianNumberingSystem(aaf_excess_amount_percent));
        $('.int_1croreto10crore_total_arbitrator_fees').text(formatToIndianNumberingSystem(total_arbitrator_fees));
        $('.int_1croreto10crore_each_party_share').text(formatToIndianNumberingSystem(each_party_share));
        $('.int_1croreto10crore_each_party_payable').text(formatToIndianNumberingSystem(each_party_payable));
    ...
    function int_calc_above_10_crore() {
        ...
        */
        ...
        $('.int_above10crore_basic_amount').text(formatToIndianNumberingSystem(basic_amount));
        $('.int_above10crore_excess_amount').text(formatToIndianNumberingSystem(excess_amount));
        $('.int_above10crore_basic_arbitrator_fees').text(formatToIndianNumberingSystem(basic_administrative_cost));
        $('.int_above10crore_aarf_excess_amount_percent').text(formatToIndianNumberingSystem(aaf_excess_amount_percent));
        $('.int_above10crore_total_arbitrator_fees').text(formatToIndianNumberingSystem(total_arbitrator_fees));
        $('.int_above10crore_each_party_share').text(formatToIndianNumberingSystem(each_party_share));
        $('.int_above10crore_each_party_payable').text(formatToIndianNumberingSystem(each_party_payable));
    ...
    function int_arb_arb_calc_10_lakhs_to_50_lakhs() {
        ...
        */
        ...
        $('.int_arb_arb_10lakhsto50lakhs_basic_amount').text(formatToIndianNumberingSystem(basic_amount));
        $('.int_arb_arb_10lakhsto50lakhs_excess_amount').text(formatToIndianNumberingSystem(excess_amount));
        $('.int_arb_arb_10lakhsto50lakhs_basic_arbitrator_fees').text(formatToIndianNumberingSystem(basic_administrative_cost));
        $('.int_arb_arb_10lakhsto50lakhs_aarf_excess_amount_percent').text(formatToIndianNumberingSystem(aaf_excess_amount_percent));
        $('.int_arb_arb_10lakhsto50lakhs_total_arbitrator_fees').text(formatToIndianNumberingSystem(total_arbitrator_fees));
        $('.int_arb_arb_10lakhsto50lakhs_each_party_share').text(formatToIndianNumberingSystem(each_party_share));
        $('.int_arb_arb_10lakhsto50lakhs_each_party_payable').text(formatToIndianNumberingSystem(each_party_payable));
    ...
    function int_arb_arb_calc_50_lakhs_to_1_crore() {
        ...
        */
        ...
        $('.int_arb_arb_50lakhsto1crore_basic_amount').text(formatToIndianNumberingSystem(basic_amount));
        $('.int_arb_arb_50lakhsto1crore_excess_amount').text(formatToIndianNumberingSystem(excess_amount));
        $('.int_arb_arb_50lakhsto1crore_basic_arbitrator_fees').text(formatToIndianNumberingSystem(basic_administrative_cost));
        $('.int_arb_arb_50lakhsto1crore_aarf_excess_amount_percent').text(formatToIndianNumberingSystem(aaf_excess_amount_percent));
        $('.int_arb_arb_50lakhsto1crore_total_arbitrator_fees').text(formatToIndianNumberingSystem(total_arbitrator_fees));
        $('.int_arb_arb_50lakhsto1crore_each_party_share').text(formatToIndianNumberingSystem(each_party_share));
        $('.int_arb_arb_50lakhsto1crore_each_party_payable').text(formatToIndianNumberingSystem(each_party_payable));
    ...
    function int_arb_arb_calc_1_crore_to_10_crore() {
        ...
        */
        ...
        $('.int_arb_arb_1croreto10crore_basic_amount').text(formatToIndianNumberingSystem(basic_amount));
        $('.int_arb_arb_1croreto10crore_excess_amount').text(formatToIndianNumberingSystem(excess_amount));
        $('.int_arb_arb_1croreto10crore_basic_arbitrator_fees').text(formatToIndianNumberingSystem(basic_administrative_cost));
        $('.int_arb_arb_1croreto10crore_aarf_excess_amount_percent').text(formatToIndianNumberingSystem(aaf_excess_amount_percent));
        $('.int_arb_arb_1croreto10crore_total_arbitrator_fees').text(formatToIndianNumberingSystem(total_arbitrator_fees));
        $('.int_arb_arb_1croreto10crore_each_party_share').text(formatToIndianNumberingSystem(each_party_share));
        $('.int_arb_arb_1croreto10crore_each_party_payable').text(formatToIndianNumberingSystem(each_party_payable));
    ...
    function int_arb_arb_calc_above_10_crore() {
        ...
        */
        ...
        $('.int_arb_arb_above10crore_basic_amount').text(formatToIndianNumberingSystem(basic_amount));
        $('.int_arb_arb_above10crore_excess_amount').text(formatToIndianNumberingSystem(excess_amount));
        $('.int_arb_arb_above10crore_basic_arbitrator_fees').text(formatToIndianNumberingSystem(basic_administrative_cost));
        $('.int_arb_arb_above10crore_aarf_excess_amount_percent').text(formatToIndianNumberingSystem(aaf_excess_amount_percent));
        $('.int_arb_arb_above10crore_total_arbitrator_fees').text(formatToIndianNumberingSystem(total_arbitrator_fees));
        $('.int_arb_arb_above10crore_each_party_share').text(formatToIndianNumberingSystem(each_party_share));
        $('.int_arb_arb_above10crore_each_party_payable').text(formatToIndianNumberingSystem(each_party_payable));
