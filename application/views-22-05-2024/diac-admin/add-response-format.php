                    ...
                    <div class="box-body">
                        <div class="col-lg-12">
                            <div class="card" style="margin-bottom: 15px;">
                                <div class="card-body">
                                    <h5 id="case-number"><strong>Case Number:</strong> <?= $case_details['case_no'] ?></h5>
                            ...
                            <?= form_open(null, array('class' => 'wfst', 'id' => 'response_format_form')) ?>
                                            ...
                                            <div class="fieldset-content-box">
                                                <div class="row">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" class="form-control" id="response_to" name="response_to"  autocomplete="off" maxlength="200" value="" />
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="control-label">Cc:</label>
                                                        <input type="text" class="form-control" id="response_cc" name="response_cc"  autocomplete="off" maxlength="200" value="" />
                                                        <small class="text-muted">Enter comma seperated e-mail ids if more than one.</small>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label class="control-label">Bcc:</label>
                                                        <input type="text" class="form-control" id="response_bcc" name="response_bcc"  autocomplete="off" maxlength="200" value="" />
                                                        <small class="text-muted">Enter comma seperated e-mail ids if more than one.</small>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-xs-12 required">
                                                        ...
                                                        <input type="text" class="form-control" id="response_subject" name="response_subject"  autocomplete="off" maxlength="200" value="" />
                                                    </div>
                                                    <div class="form-group col-xs-12 required">
                                                        <label class="control-label">Body:</label>
                                                        <textarea type="text" class="form-control response-summernote-text-editor" id="response_body" name="response_body"  autocomplete="off" value=""></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </fieldset>
                                ...
                                <div class="row text-center mt-25">
                                    <div class="col-xs-12">
                                        <button type="reset" class="btn btn-danger" id="btnSaveAndDownload"><i class="fa fa-save"></i> Save & Download</button>
                                        <button type="submit" class="btn btn-custom response_btn_submit" id="btnSaveAndSend"><i class='fa fa-paper-plane'></i> Save & Send</button>
                                    </div>
                                </div>
                            <?= form_close() ?>
