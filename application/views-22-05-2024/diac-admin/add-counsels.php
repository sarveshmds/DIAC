										...
										<div class="fieldset-content-box">
											<div class="row">
												<div class="form-group col-md-3 col-sm-6 col-xs-12">
													...
													<input type="text" name="permanent_address_1" id="permanent_address_1" class="form-control" value="<?= isset($counsels_data['perm_address_1']) ? $counsels_data['perm_address_1'] : '' ?>">
												</div>
												<div class="form-group col-md-3 col-sm-6 col-xs-12">
													<label class="control-label">Address 2</label>
													<input type="text" name="permanent_address_2" id="permanent_address_2" class="form-control" value="<?= isset($counsels_data['perm_address_2']) ? $counsels_data['perm_address_2'] : '' ?>">
												</div>
												<div class="form-group col-md-3 col-sm-6 col-xs-12">
												...
												<div class="form-group col-md-3 col-sm-6 col-xs-12">
													...
													<input type="text" class="form-control" id="permanent_pincode" name="permanent_pincode" value="<?= isset($counsels_data['perm_pincode']) ? $counsels_data['perm_pincode'] : '' ?>">
												</div>
											</div>
										</div>
									</fieldset>
									...
									<fieldset class="fieldset">
										...
										<div class="fieldset-content-box">
											<div class="row">
												<div class="form-group col-md-3 col-sm-6 col-xs-12">
													<label class="control-label">Address 1</label>
													<input type="text" name="corr_address_1" id="corr_address_1" class="form-control" value="<?= isset($counsels_data['corr_address_1']) ? $counsels_data['corr_address_1'] : '' ?>">
												</div>
												<div class="form-group col-md-3 col-sm-6 col-xs-12">
													<label class="control-label">Address 2</label>
													<input type="text" name="corr_address_2" id="corr_address_2" class="form-control" value="<?= isset($counsels_data['corr_address_2']) ? $counsels_data['corr_address_2'] : '' ?>">
												</div>
												<div class="form-group col-md-3 col-sm-6 col-xs-12">
													<label class="control-label">Country</label>
												...
												<div class="form-group col-md-3 col-sm-6 col-xs-12">
													<label class="control-label">Pincode</label>
													<input type="text" class="form-control" id="corr_pincode" name="corr_pincode" value="<?= isset($counsels_data['corr_pincode']) ? $counsels_data['corr_pincode'] : '' ?>">
												</div>
											</div>
										</div>
									</fieldset>
