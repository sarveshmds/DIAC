            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="box wrapper-box">
                    <div class="box-body">
                        ...
                        <div>
                            <table id="datatable_my_cases" class="table table-condensed table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th width="8%">S. No.</th>
                                        <th>Diary No.</th>
...
<script>
    $(document).ready(function() {
        var datatable_applications = $("#datatable_my_cases").dataTable({
            ...
            searching: false,
            ajax: {
                url: base_url + "ims/efiling/vakalatnama/get-datatable-list",
                type: "POST",
                data: function(data) {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    sClass: "text-center",
                    render: function(data, type, row, meta) {
                        return "  <button class='btn_change_status btn btn-success btn-sm' type='button' data-beneficiary-id='" + data.id + "' title='Approve/Reject'><i class='fa fa-check-square'></i></button> <a href='" + base_url + "public/upload/efiling/vakalatnamas/" + data.upload + "' class='action-icon tooltipTable tooltipTable btn btn-primary btn-sm' title='View Document' target='_BLANK'><i class='fa fa-file'></i></a> ";
                    },
                },
            ],
            columnDefs: [{
    ...
    $("#change_status_form").bootstrapValidator({
        ...
        submitHandler: function(validator, form, submitButton) {
            ...
            $.ajax({
                url: base_url + "change_vakalatnama_status",
                method: "POST",
                data: formData,
                contentType: false,
                processData: false,
