...
function success_response_with_commit($msg, $data = [])
{
    $CI = &get_instance();
    $CI->db->trans_commit();
    $data = array(
        ...
        'redirect_url' => (isset($data['redirect_url']) && !empty($data['redirect_url'])) ? $data['redirect_url'] : ''
    );
    echo json_encode($data);
    die;
}

function failed_response_with_rollback($msg, $data = [])
{
    $CI = &get_instance();
    $CI->db->trans_rollback();
    $data = array(
