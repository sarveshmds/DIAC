									...
									<div class="tab-content-col">
										...
										<div class="row">
											...
											<div class="col-xs-12">
												<div class="box box-warning">
													<div class="box-header with-border">
														<h4 class="box-title"><i class="fa fa-arrow-right"></i> Counter Claim</h4>
													</div>
													<div class="box-body">
														<div class="form-group col-md-3 col-sm-6 col-xs-12 ">
											...
											<div class="col-xs-12">
												<div class="box box-warning">
													<div class="box-header with-border">
														<h4 class="box-title"><i class="fa fa-arrow-right"></i> Application under Section 17 of A&C Act</h4>
													</div>
													<div class="box-body">
														<div class="form-group col-md-3 col-sm-6 col-xs-12">
												...
												<div class="box box-warning">
													<div class="box-header with-border">
														<h4 class="box-title"><i class="fa fa-arrow-right"></i> Application under Section 16 of A&C Act</h4>
													</div>
													<div class="box-body">
														<div class="form-group col-md-3 col-sm-6 col-xs-12">
												...
												<div class="box box-warning">
													<div class="box-body">
														<div class="form-group col-md-12 col-sm-12 col-xs-12">
															...
															<textarea class="form-control" rows="4" id="sop_remarks" name="sop_remarks"><?php echo (isset($sop_data['remarks'])) ? $sop_data['remarks'] : '' ?></textarea>
