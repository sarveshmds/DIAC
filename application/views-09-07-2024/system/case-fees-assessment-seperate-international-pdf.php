            ...
            <div>
                ...
                <table class="table table-responsive table-bordered" style="margin-bottom: 0px;">
                    ...
                    <?php if ($assessment['arbitral_tribunal_strength'] == 1) : ?>
                        <tr>
                            ...
                            <td>
                                <?= (isset($assessment['cc_excess_amount'])) ? symbol_checker($case_data['type_of_arbitration'], $assessment['cc_excess_amount']) : ''  ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?= (isset($assessment['cc_additional_arb_amount'])) ? symbol_checker($case_data['type_of_arbitration'], $assessment['cc_additional_arb_amount']) : ''  ?>
                            </td>
                        </tr>
                    <?php endif; ?>
                    ...
                    <tr style="background-color: yellow;">
                        ...
                        <td>
                            <?= (isset($assessment['cc_int_arb_total_fees_dollar'])) ? symbol_checker($case_data['type_of_arbitration'], $assessment['cc_int_arb_total_fees_dollar']) : ''  ?>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-responsive table-bordered">
                    <tr>
                        ...
                        <td>
                            <?= (isset($assessment['int_arb_res_share_fees_dollar'])) ? symbol_checker($case_data['type_of_arbitration'], $assessment['int_arb_res_share_fees_dollar']) : ''  ?>

                            <?php $claimant_share += $assessment['int_arb_res_share_fees_dollar']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td width="70%">
                        ...
                        <td>
                            <?= (isset($assessment['int_res_adm_charges_dollar'])) ? symbol_checker($case_data['type_of_arbitration'], $assessment['int_res_adm_charges_dollar']) : ''  ?>
                            <?php $claimant_share += $assessment['int_res_adm_charges_dollar']; ?>
                        </td>
                    </tr>
                    <tr style="background-color: yellow;">
                        <td width="70%">
                ...
                <div>
                    ...
                    <table class="table table-responsive table-bordered" style="margin-bottom: 0px;">
                        <tr>
                            ...
                            <td>
                                <?= (isset($assessment['cc_adm_basic_amount'])) ? INDMoneyFormat($assessment['cc_adm_basic_amount']) : ''  ?>
                            </td>
                        </tr>
                        <tr>
                            <td width="70%">
                            ...
                            <td>
                                <?= (isset($assessment['cc_adm_basic_adm_fees'])) ? INDMoneyFormat($assessment['cc_adm_basic_adm_fees']) : ''  ?>
                            </td>
                        </tr>

                        <tr>
                            <td width="70%">
                                <strong>Additional Fees@ <?= $assessment['cc_adm_excess_percentage'] ?>% of excess amount: </strong>
                            </td>
                            <td>
                                <?= (isset($assessment['cc_adm_actual_excess_amount'])) ? INDMoneyFormat($assessment['cc_adm_actual_excess_amount']) : ''  ?>
                            </td>
                        </tr>
                        ...
                        <tr style="background-color: yellow;">
                            ...
                            <td>
                                <?= (isset($assessment['cc_int_total_adm_charges_rupee'])) ? INDMoneyFormat($assessment['cc_int_total_adm_charges_rupee']) : ''  ?>
                            </td>
                        </tr>
                    </table>
