                    ...
                    if (response.status == true) {
                        ...
                        if (type_of_arbitration == 'DOMESTIC') {
                            if (claim_amount >= 500000) {
                                ...
                                var tr_ex = '';
                                if (data.excess_amount_percent_details.ceiling_text) {
                                    tr_excess_amount_details = `
                                        <tr>
                                            <th>${data.excess_amount_percent_details.text}:</th>
                                            <td>${formatToIndianNumberingSystem(data.excess_amount_percent_details.total_arb_excess_amount_without_ceil)}</td>
                                        </tr>
                                        <tr>
                                            <th>${data.excess_amount_percent_details.ceiling_text}:</th>
                                ...
                                content = `
                                            <table class="table" style="border: 1px solid lightgrey;">
                                                <tr class="fc_border_bottom bg-dark text-white">
                                                ...
                                                <tr class="fc_border_bottom fc_border_top">
                                                    <th>Total:</th>
                                                    <td>${formatToIndianNumberingSystem(basic_arbitrator_fees+excess_amount_percent)}</td>
                                                </tr>
