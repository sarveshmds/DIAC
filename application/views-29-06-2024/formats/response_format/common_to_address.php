        ...
        <?php foreach ($parties as $key => $party) : ?>
            <?php if ($party['type'] == 'claimant') : ?>
                <div <?= ($key > 1) ? 'style = "margin-top: 6px;"' : '' ?>>
                    ...
                    <?php endif; ?>
                    <?php if ((isset($party['perm_state_name']) && $party['perm_state_name'])) : ?>
                        <p style="margin-bottom: 1px;">
                            <?= $party['perm_state_name'] ?>
                        </p>
                    <?php endif; ?>
                    <?php if ((isset($party['perm_country_name']) && $party['perm_country_name'])) : ?>
                        <p style="margin-bottom: 1px;">
                            <?= $party['perm_country_name'] ?>
                            <?php if ((isset($party['perm_pincode']) && $party['perm_pincode'])) : ?>
                                - <?= $party['perm_pincode'] ?>
                            <?php endif; ?>
                        </p>
                    <?php endif; ?>
        ...
        <div style="width: 50%; float: left;">
            <?php foreach ($claimant_counsels as $key => $counsel) : ?>
                <div <?= ($key > 1) ? 'style = "margin-top: 6px;"' : '' ?>>
                    ...
                    <?php endif; ?>
                    <?php if ((isset($counsel['perm_state_name']) && $counsel['perm_state_name'])) : ?>
                        <p style="margin-bottom: 1px;">
                            <?= $counsel['perm_state_name'] ?>
                        </p>
                    <?php endif; ?>
                    <?php if ((isset($counsel['perm_country_name']) && $counsel['perm_country_name'])) : ?>
                        <p style="margin-bottom: 1px;">
                            <?= $counsel['perm_country_name'] ?>
                            <?php if ((isset($counsel['perm_pincode']) && $counsel['perm_pincode'])) : ?>
                                - <?= $counsel['perm_pincode'] ?>
                            <?php endif; ?>
                        </p>
                    <?php endif; ?>
