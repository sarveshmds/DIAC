        ...
        var datatable_applications = $("#datatable_my_cases").dataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    sClass: "text-center",
                    render: function(data, type, row, meta) {
                        return "<a href='" + base_url + "efiling/view-case-fees/" + data.case_no + "' class='btn btn-warning btn-sm btn-pill w-100 mb-1'  title='Fees'><i class='fa fa-money'></i> Fee</a> <a href='" + base_url + "efiling/view-case-details/" + data.case_no + "' class='btn btn-success btn-sm btn-pill w-100 mb-1'  title='View'><i class='fa fa-eye'></i> View</a> <a href='" + base_url + "efiling/case/hearings?case_no=" + data.case_no + "' class='btn btn-info btn-sm btn-pill w-100 mb-1' title='Case Hearings'><i class='fa fa-balance-scale'></i> Hearings</a>";
                    },
                },
            ],
            columnDefs: [{
