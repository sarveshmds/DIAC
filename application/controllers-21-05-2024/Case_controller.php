...
class Case_controller extends CI_Controller
{
	public function __construct()
	{
		...
		# models
		$this->load->model(array('common_model', 'case_model', 'category_model', 'fees_model', 'notification_model', 'refferal_request_model', 'panel_category_model', 'claimant_respondent_model', 'arbitral_tribunal_model', 'master_setup/arbitrator_setup_model'));
	...
	*/
	...
	public function arbitral_tribunal($case_no = '')
	{
		...
		if ($page_status != 0) {
			...
			if (isset($case_no) && !empty($case_no)) {
				$data['arbitrators_name'] = $this->getter_model->get(null, 'get_arbitrators_name');
