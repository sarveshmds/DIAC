...
class Daw_model extends CI_Model
{
    ...
    {
        $this->db->select("drt.*, s.name as state_name, c.name as country_name, gcd.description as salutation_desc, gcd2.description as registrant_category_desc, gcd3.description as hear_about_event_desc");
