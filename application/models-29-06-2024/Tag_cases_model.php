...
class Tag_cases_model extends CI_Model
{
    ...
    public function get_all_other_noting_messages_datatable()
    {
        ...
        $this->db->select("ctc.*, cdt.case_no as master_case_desc, cdt.case_title as master_case_title, cdt2.case_no as tagged_case_desc, cdt2.case_title as tagged_case_title, GROUP_CONCAT(cdt2.case_no) as tagged_cases");
