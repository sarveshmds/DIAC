  	...
  	<div class="content-wrapper">
    	<section class="content">
      		<div class="page_background">
				<main>
		  			<svg xmlns="" width="300" height="300" viewBox="0 0 100 68">
				   		 <g id="large">
				  	...
				  	<h1 style="font-size: 3em;font-weight: 100;color: #F44;margin: 0;">Under Maintanance</h1>
				  	<h2 style="font-size: 1.5em;font-weight: 100;margin-top: 0;">Sorry for the inconvenience.</h2>
		  			<h3 style="font-size: 1.5em;font-weight: 100;margin-top: 0;">To contact us in the meantime please visit:</h3>
		  			<a href="#" style="font-size: 1.5em;font-weight: 300;color: #F44;text-decoration: none;">DIAC</a>
				</main>
			</div>
    	</section>
  	</div>