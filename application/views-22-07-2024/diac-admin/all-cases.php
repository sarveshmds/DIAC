...
<script type="text/javascript" src="<?= base_url('public/custom/js/diac_dashboard/all-cases.js?v=' . filemtime(FCPATH . 'public/custom/js/diac_dashboard/all-cases.js')) ?>"></script>