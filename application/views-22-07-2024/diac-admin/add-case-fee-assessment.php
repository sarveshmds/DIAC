                        ...
                        <div class="">
                            ...
                            <div class="row">
                                                        ...
                                                        <div class="claimant_claim_amount_form_col">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-2 col-sm-6 col-xs-12 form-group">
                                                                    ...
                                                                    <select name="is_quantified" id="is_quantified" class="form-control" disabled>
                                                                        <option value="">Select</option>
                                                                        <option value="1">Yes</option>
                                                                        <option value="2">No</option>
                                                                    </select>
                                ...
                                <div class="form-group col-md-12 col-xs-12">
                                    <label for="" class="">Remarks (If any)</label>
                                    <textarea id="remarks" name="remarks" class="form-control customized-summernote" rows="4">
                                        <div style="line-height: 25px;">
                                            <ol>
                                                <li>
                                                    <strong>
                                                        <u>
                                                            Date of commencement of Arbitration in terms of Sec. 21 of the Arb. Act. :
                                                        </u>
                                                    </strong> 
                                                </li>
                                                <li>
                                                    <strong><u>Reference:</u></strong> High Court / MSEFC / Joint request of parties
                                                </li>
                                                <li>
                                                    <strong>
                                                        <u>Fee Rules applicable to the case:</u>
                                                    </strong> (Tick as applies)
                                                    <ul>
                                                        <li>
                                                        ...
                                                        <li>
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    Fee Rules effective upto 31.11.2022; or
                                                                </li>
                                                                <li>
                                                                    Fee Rules effective from 01.12.2022
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                ...
                                                <li>
                                                    <strong>
                                                        <u>Administrative Costs applicable:</u>
                                                    </strong> (Tick as applies)
                                                    <ul>
                                                        <li>
                                                            Rules effective upto 30.11.2022
                                                        </li>
                                                        <li>
                                                            Rules effective on or after 01.12.2022
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ol>
                            ...
                            <div class="calculation_col" <?= (isset($case_data['type_of_arbitration']) && ($case_data['type_of_arbitration'] == 'DOMESTIC' || $case_data['type_of_arbitration'] == 'INTERNATIONAL') && !empty($assessment)) ? '' : 'style="display: none;"'; ?>>
                                ...
                                <!-- Hidden Fields for assessment sheet - Claim -->
                                <input type="hidden" name="fc_basic_amount" id="fc_basic_amount" value="" />
                                <input type="hidden" name="fc_actual_excess_amount" id="fc_actual_excess_amount" value="" />
                                <input type="hidden" name="fc_basic_arb_fees" id="fc_basic_arb_fees" value="" />
                                <input type="hidden" name="fc_excess_percentage" id="fc_excess_percentage" value="" />
                                <input type="hidden" name="fc_excess_amount" id="fc_excess_amount" value="" />
                                <input type="hidden" name="fc_additional_arb_percentage" id="fc_additional_arb_percentage" value="" />
                                <input type="hidden" name="fc_additional_arb_amount" id="fc_additional_arb_amount" value="" />

                                <!-- Hidden Fields for assessment sheet - Counter Claim -->
                                <input type="hidden" name="fc_cc_basic_amount" id="fc_cc_basic_amount" value="" />
                                <input type="hidden" name="fc_cc_actual_excess_amount" id="fc_cc_actual_excess_amount" value="" />
                                <input type="hidden" name="fc_cc_basic_arb_fees" id="fc_cc_basic_arb_fees" value="" />
                                <input type="hidden" name="fc_cc_excess_percentage" id="fc_cc_excess_percentage" value="" />
                                <input type="hidden" name="fc_cc_excess_amount" id="fc_cc_excess_amount" value="" />
                                <input type="hidden" name="fc_cc_additional_arb_percentage" id="fc_cc_additional_arb_percentage" value="" />
                                <input type="hidden" name="fc_cc_additional_arb_amount" id="fc_cc_additional_arb_amount" value="" />

                                <!-- Hidden Fields for assessment sheet - Administrative Charges - Claim -->
                                <input type="hidden" name="fc_adm_basic_amount" id="fc_adm_basic_amount" value="" />
                                <input type="hidden" name="fc_adm_actual_excess_amount" id="fc_adm_actual_excess_amount" value="" />
                                <input type="hidden" name="fc_adm_basic_adm_fees" id="fc_adm_basic_adm_fees" value="" />
                                <input type="hidden" name="fc_adm_excess_percentage" id="fc_adm_excess_percentage" value="" />
                                <input type="hidden" name="fc_adm_excess_amount" id="fc_adm_excess_amount" value="" />
                                <input type="hidden" name="fc_adm_additional_arb_percentage" id="fc_adm_additional_arb_percentage" value="" />
                                <input type="hidden" name="fc_adm_additional_arb_amount" id="fc_adm_additional_arb_amount" value="" />

                                <!-- Hidden Fields for assessment sheet - Administrative Charges - Counter Claim -->
                                <input type="hidden" name="fc_cc_adm_basic_amount" id="fc_cc_adm_basic_amount" value="" />
                                <input type="hidden" name="fc_cc_adm_actual_excess_amount" id="fc_cc_adm_actual_excess_amount" value="" />
                                <input type="hidden" name="fc_cc_adm_basic_adm_fees" id="fc_cc_adm_basic_adm_fees" value="" />
                                <input type="hidden" name="fc_cc_adm_excess_percentage" id="fc_cc_adm_excess_percentage" value="" />
                                <input type="hidden" name="fc_cc_adm_excess_amount" id="fc_cc_adm_excess_amount" value="" />
                                <input type="hidden" name="fc_cc_adm_additional_arb_percentage" id="fc_cc_adm_additional_arb_percentage" value="" />
                                <input type="hidden" name="fc_cc_adm_additional_arb_amount" id="fc_cc_adm_additional_arb_amount" value="" />
                                            ...
                                            <div class="fieldset-content-box">
                                                <div class="domestic_calculation_col" <?= (isset($case_data['type_of_arbitration']) && $case_data['type_of_arbitration'] == 'DOMESTIC') ? '' : 'style="display: none;"' ?>>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-12 cc_total_arb_fees_col" style="display: none;">
                                                            <div class="row">
                                                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                                                    <label class="control-label">Total Arbitrators Fees (Counter Claim):</label>
                                                                    <input type="number" data-help-block-id="help_fc_cc_total_arb_fees" class="form-control amount_field" rows="5" id="fc_cc_total_arb_fees" name="fc_cc_total_arb_fees" autocomplete="off" maxlength="200" value="<?= edit_value($assessment, 'total_arb_fees') ?>" readonly>
                                                                    <p id="help_fc_cc_total_arb_fees" class="amount_help_block"></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <fieldset class="fieldset">
                                                                ...
                                                                <div class="fieldset-content-box">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-xs-12 cc_international_total_arb_adm_fees_col" style="display: none;">
                                                                            <div class="row">
                                                                                <div class="col-md-12 col-xs-12">
                                                                                    <label for="">
                                                                                        Total Arbitrator Fees
                                                                                    ...
                                                                                    <div class="input-group form-group">
                                                                                        <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
                                                                                        <input type="number" name="cc_int_arb_total_fees_dollar" id="cc_int_arb_total_fees_dollar" value="<?= edit_value($assessment, 'cc_int_arb_total_fees_dollar') ?>" class="form-control" readonly />
                                                                                    </div>

                                                                                    <div class="input-group form-group">
                                                                                        <span class="input-group-addon">Rs.</span>
                                                                                        <input type="number" name="cc_int_arb_total_fees_rupee" id="cc_int_arb_total_fees_rupee" value="<?= edit_value($assessment, 'cc_int_arb_total_fees_rupee') ?>" class="form-control" readonly />
                                                                                    </div>
                                                                                ...
                                                                                <div class="col-md-12 col-xs-12">
                                                                                    ...
                                                                                    <div class="input-group form-group">
                                                                                        <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
                                                                                        <input type="number" name="cc_int_total_adm_charges_dollar" id="cc_int_total_adm_charges_dollar" value="<?= edit_value($assessment, 'cc_int_total_adm_charges_dollar') ?>" class="form-control" readonly />
                                                                                    </div>

                                                                                    <div class="input-group form-group">
                                                                                        <span class="input-group-addon">Rs.</span>
                                                                                        <input type="number" name="cc_int_total_adm_charges_rupee" id="cc_int_total_adm_charges_rupee" value="<?= edit_value($assessment, 'cc_int_total_adm_charges_rupee') ?>" class="form-control" readonly />
                                                                                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function calculate_claimant_total_amount(claimant_prayers) {
            ...
            $('.claimant_sum_in_dispute').html(`<strong>Total:</strong> ${($('#type_of_arbitration').val() == 'INTERNATIONAL') ? toUSCurrency(claimant_sum_in_dispute) : toIndianCurrency(claimant_sum_in_dispute)}`)
                ...
                claimant_prayers.forEach((cp, index) => {
                    ...
                    cp_html += `
                        <tr>
                            ...
                            <td>${applicable}</td>
                            <td>${quantified}</td>
                            <td>${($('#type_of_arbitration').val() == 'INTERNATIONAL') ? toUSCurrency(prayer_amount) : toIndianCurrency(prayer_amount)}</td>
        ...
        function calculate_respondent_total_amount(respondent_prayers) {
            ...
            $('.respondent_sum_in_dispute').html(`<strong>Total</strong> ${($('#type_of_arbitration').val() == 'INTERNATIONAL') ? toUSCurrency(respondent_sum_in_dispute) : toIndianCurrency(respondent_sum_in_dispute)}`)
        ...
        $('#btn_calculate_fees').on('click', function() {
            ...
            $(".cc_total_arb_fees_col").hide();
            $('.cc_international_total_arb_adm_fees_col').hide();
            ...
            if (fc_c_cc_assessed_sep == 'yes') {
                ...
                console.log(claim_amount, arbitral_tribunal_strength, type_of_arbitration)
        ...
        $("#assessment_form").on("submit", async function(e) {
            ...
            // console.log(assessment_sheet_data)
