				...
				<fieldset>
					...
					<div class="col-md-12">
						<div class="form-group col-md-6 col-sm-6 col-xs-12 required">
							<label class="control-label">Case List</label>
						...
						<div class="form-group col-md-4 col-sm-6 col-xs-12 required">
							...
							<select class="form-control" id="arbitrator_name" name="arbitrator_name">
								...
								<?php foreach ($arbitrators_list as $arbitrators) : ?>
									<option value="<?= $arbitrators['code'] ?>"><?= $arbitrators['name_of_arbitrator'] . ' (' . $arbitrators['category_name'] . ')' ?></option>
								<?php endforeach ?>
							</select>
