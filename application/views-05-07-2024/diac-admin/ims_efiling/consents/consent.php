...
<script>
    $(document).ready(function() {
        var datatable_document_pleadings = $("#datatable_document_pleadings").dataTable({
            ...
            searching: false,
            ajax: {
                url: base_url + "ims/efiling/consent/get-datatable-list",
                type: "POST",
                data: function(data) {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    sClass: "text-center",
                    render: function(data, type, row, meta) {
                        return "<a href='" + base_url + "ims/efiling/consent/view?code=" + data.c_code + "' class='action-icon tooltipTable tooltipTable btn btn-custom btn-sm' title='View Details'><i class='fa fa-eye'></i></a> <button class='btn_change_status btn btn-success btn-sm' type='button' data-beneficiary-id='" + data.id + "' title='Approve/Reject'><i class='fa fa-check-square'></i></button> <a href='" + base_url + "public/upload/efiling/consent/" + data.upload + "' class='action-icon tooltipTable tooltipTable btn btn-primary btn-sm' title='View Document' target='_BLANK'><i class='fa fa-file'></i></a> ";
                    },
                },
            ],
            columnDefs: [{
    ...
    $("#change_status_form").bootstrapValidator({
        ...
        submitHandler: function(validator, form, submitButton) {
            ...
            $.ajax({
                url: base_url + "change_consent_status",
                method: "POST",
                data: formData,
                contentType: false,
                processData: false,
