						...
						<div class="col-lg-12">
							<div id="accordion">
								<h3 class="accordion-header"><i class="fa fa-file"></i> Case Details
									<small class="last-updated-text">(Last Updated:
										<?php echo date(
											'd-m-Y',
											strtotime($case_data['last_updated']['case_details_last_updated']['last_updated_at'])
										);
										?>)
									</small>
								...
								<!-- ================================================== -->
								<!-- Claimant and respondant -->
								<h3 class="accordion-header"><i class="fa fa-users"></i> Claimants & Respondants
									<small class="last-updated-text">(Last Updated:
										<?=
										(!empty($case_data['last_updated']['claim_res_last_updated']['last_updated_at'])) ?
											date(
												'd-m-Y',
												strtotime($case_data['last_updated']['claim_res_last_updated']['last_updated_at'])
											) : 'No Update';
										?>)
									</small>
								...
								<h3 class="accordion-header"><i class="fa fa-pencil"></i> Status of Pleadings
									...
									<small class="last-updated-text">(Last Updated:
										<?=
										(!empty($case_data['last_updated']['sop_last_updated']['last_updated_at'])) ?
											date(
												'd-m-Y',
												strtotime($case_data['last_updated']['sop_last_updated']['last_updated_at'])
											) : 'No Update';
										?>)
									</small>
								...
								<h3 class="accordion-header"><i class="fa fa-retweet"></i> Counsels
									<small class="last-updated-text">(Last Updated:
										<?=
										(!empty($case_data['last_updated']['counsels_last_updated']['last_updated_at'])) ?
											date(
												'd-m-Y',
												strtotime($case_data['last_updated']['counsels_last_updated']['last_updated_at'])
											) : 'No Update';
										?>)
									</small>
								...
								<h3 class="accordion-header"><i class="fa fa-sticky-note-o"></i> Arbitral Tribunals
									<small class="last-updated-text">(Last Updated:
										<?=
										(!empty($case_data['last_updated']['arb_tri_last_updated']['last_updated_at'])) ?
											date(
												'd-m-Y',
												strtotime($case_data['last_updated']['arb_tri_last_updated']['last_updated_at'])
											) : 'No Update';
										?>)
									</small>
									<span class="fa fa-plus pull-right"></span>
								...
								<h3 class="accordion-header"><i class="fa fa-pencil-square-o"></i> Notings
									<small class="last-updated-text">(Last Updated:
										<?=
										(!empty($case_data['last_updated']['noting_last_updated']['last_updated_at'])) ?
											date(
												'd-m-Y',
												strtotime($case_data['last_updated']['noting_last_updated']['last_updated_at'])
											) : 'No Update';
										?>)
									</small>
									<span class="fa fa-plus pull-right"></span>
										...
										<tbody>
											...
											<?php foreach ($case_data['notings'] as $nt) : ?>
												<tr>
													...
													<td><?= formatReadableDate($nt['noting_date']) ?></td>
													<td>
														<?= $nt['marked_by_user'] ?>
													</td>
								...
								<!-- =============================================== -->
								<!-- E-filing Documents -->
								<h3 class="accordion-header"><i class="fa fa-pencil-square-o"></i> Filed Documents
									<small class="last-updated-text">(Last Updated:
										<?=
										(!empty($case_data['last_updated']['noting_last_updated']['last_updated_at'])) ?
											date(
								...
								<h3 class="accordion-header"><i class="fa fa-pencil-square-o"></i> Filed Applications
									<small class="last-updated-text">(Last Updated:
										<?=
										(!empty($case_data['last_updated']['noting_last_updated']['last_updated_at'])) ?
											date(
								...
								<h3 class="accordion-header"><i class="fa fa-pencil-square-o"></i> Filed Vakalatnama
									<small class="last-updated-text">(Last Updated:
										<?=
										(!empty($case_data['last_updated']['noting_last_updated']['last_updated_at'])) ?
											date(
								...
								<!-- =============================================== -->
								<!-- E-filing Consents -->
								<h3 class="accordion-header"><i class="fa fa-pencil-square-o"></i> Filed Concents
									<small class="last-updated-text">(Last Updated:
										<?=
										(!empty($case_data['last_updated']['noting_last_updated']['last_updated_at'])) ?
											date(
								...
								<h3 class="accordion-header"><i class="fa fa-money"></i> Fee Details
									<small class="last-updated-text">(Last Updated:
										<?=
										(!empty($case_data['last_updated']['fee_cost_last_updated']['last_updated_at'])) ?
											date(
												'd-m-Y',
												strtotime($case_data['last_updated']['fee_cost_last_updated']['last_updated_at'])
											) : 'No Update';
										?>)
									</small>
									<span class="fa fa-plus pull-right"></span>
								...
								<h3 class="accordion-header"><i class="fa fa-trophy"></i> Termination
									<small class="last-updated-text">(Last Updated:
										<?=
										(!empty($case_data['last_updated']['award_term_last_updated']['last_updated_at'])) ?
											date(
												'd-m-Y',
												strtotime($case_data['last_updated']['award_term_last_updated']['last_updated_at'])
											) : 'No Update';
										?>)
									</small>
									<span class="fa fa-plus pull-right"></span>
								...
								<h3 class="accordion-header"><i class="fa fa-map-o"></i> Hearings
									<small class="last-updated-text">(Last Updated:
										<?=
										(!empty($case_data['last_updated']['hearings_last_updated']['last_updated_at'])) ?
											date(
												'd-m-Y',
												strtotime($case_data['last_updated']['hearings_last_updated']['last_updated_at'])
											) : 'No Update';
										?>)
									</small>
										...
										<tbody>
											...
											<?php foreach ($case_data['hearings'] as $hearings) : ?>
												<tr>
													...
													<td><?= $hearings['room_no'] ?></td>
													<td><?php if ($hearings['active_status'] == 1): ?>
