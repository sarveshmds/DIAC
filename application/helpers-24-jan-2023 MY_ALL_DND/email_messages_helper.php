...
function send_arbitrator_for_consent($at_data, $case_data = '')
{
    ...
    $body = '
        ...
        <p><small>If you want to submit the consent online then create your account in our efiling portal with your registered email id and mobile number which is ' . $at_data['email'] . ' & ' . $at_data['phone'] . '</small></p>
