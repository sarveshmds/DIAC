                    ...
                    if ($this->form_validation->run()) {
                        ...
                        try {
                            ...
                            if ($result) {
                                ...
                                $claimants = $this->claimant_respondent_model->get_cla_res_basic_info_using_case_and_slug($case_no_slug, CLAIMANT_TYPE_CONSTANT);
                                ...
                                // ================================================
                                // Respondents =====================
                                $respondants = $this->claimant_respondent_model->get_cla_res_basic_info_using_case_and_slug($case_no_slug, RESPONDANT_TYPE_CONSTANT);
                                ...
                                $arbitrators = $this->arbitral_tribunal_model->getBasicArbitratorData($case_no_slug);
                                ...
                                // die;
                                $email_send_result = case_registered_info_to_all(strtolower($all_emails_string), $subject, $email_html_body);
                                // $email_send_result = [
                                //     'status' => true,
                                // ];
