	...
	*/
	...
	public function _remap($method)
	{
		...
		$role_action_auth = array(
			...
			'DEO' => array(
				'all_cases', 'claimant_respondant_details', 'counsels', 'arbitral_tribunal', 'view_case', 'allotted_case', 'view_fees_details', 'edit_case_details', 'update_case_details', 'add_counsels', 'edit_counsels',
			),
		);
